...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 87 04 00 00       	call   49b <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 d0 0c 00 00       	push   $0xcd0
   ppid = getpid();
  1c:	a3 d8 0c 00 00       	mov    %eax,0xcd8
   lock_init(&lock);
  21:	e8 da 03 00 00       	call   400 <lock_init>

   int i;
   for (i = 0; i < num_threads; i++) {
  26:	a1 cc 0c 00 00       	mov    0xccc,%eax
  ...
  6b:	68 b2 08 00 00       	push   $0x8b2
  70:	6a 01                	push   $0x1
  72:	e8 09 05 00 00       	call   580 <printf>
  77:	83 c4 0c             	add    $0xc,%esp
  7a:	68 ba 08 00 00       	push   $0x8ba
   }

   for (i = 0; i < num_threads; i++) {
      int join_pid = thread_join();
      assert(join_pid > 0);
  7f:	68 c9 08 00 00       	push   $0x8c9
  84:	6a 01                	push   $0x1
  86:	e8 f5 04 00 00       	call   580 <printf>
  8b:	5a                   	pop    %edx
  8c:	59                   	pop    %ecx
  8d:	68 dd 08 00 00       	push   $0x8dd
  92:	6a 01                	push   $0x1
  94:	e8 e7 04 00 00       	call   580 <printf>
  99:	5b                   	pop    %ebx
  9a:	ff 35 d8 0c 00 00    	push   0xcd8
  a0:	e8 a6 03 00 00       	call   44b <kill>
  a5:	e8 71 03 00 00       	call   41b <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 cc 0c 00 00       	mov    0xccc,%eax
  ...
  cd:	6a 2a                	push   $0x2a
  cf:	68 a8 08 00 00       	push   $0x8a8
  d4:	68 b2 08 00 00       	push   $0x8b2
  d9:	6a 01                	push   $0x1
  db:	e8 a0 04 00 00       	call   580 <printf>
  e0:	83 c4 0c             	add    $0xc,%esp
  e3:	68 ea 08 00 00       	push   $0x8ea
  e8:	eb 95                	jmp    7f <main+0x7f>
   }

   assert(global == num_threads * loops);
  ea:	0f af 05 c8 0c 00 00 	imul   0xcc8,%eax
  f1:	3b 05 d4 0c 00 00    	cmp    0xcd4,%eax
  f7:	74 20                	je     119 <main+0x119>
  f9:	6a 2d                	push   $0x2d
  fb:	68 a8 08 00 00       	push   $0x8a8
 100:	68 b2 08 00 00       	push   $0x8b2
 105:	6a 01                	push   $0x1
 107:	e8 74 04 00 00       	call   580 <printf>
 10c:	83 c4 0c             	add    $0xc,%esp
 10f:	68 f7 08 00 00       	push   $0x8f7
 114:	e9 66 ff ff ff       	jmp    7f <main+0x7f>

   printf(1, "TEST PASSED\n");
 119:	50                   	push   %eax
 11a:	50                   	push   %eax
 11b:	68 15 09 00 00       	push   $0x915
 120:	6a 01                	push   $0x1
 122:	e8 59 04 00 00       	call   580 <printf>
   exit();
 127:	e8 ef 02 00 00       	call   41b <exit>
...
worker(void *arg1, void *arg2) {
 ...
 134:	83 ec 04             	sub    $0x4,%esp
   int i, j, tmp;
   for (i = 0; i < loops; i++) {
 137:	a1 c8 0c 00 00       	mov    0xcc8,%eax
 ...
 14b:	83 c3 01             	add    $0x1,%ebx
      lock_acquire(&lock);
 14e:	68 d0 0c 00 00       	push   $0xcd0
 153:	e8 88 02 00 00       	call   3e0 <lock_acquire>
      tmp = global;
      for(j = 0; j < 50; j++); // take some time
      global = tmp + 1;
      lock_release(&lock);
 158:	c7 04 24 d0 0c 00 00 	movl   $0xcd0,(%esp)
      global = tmp + 1;
 15f:	83 05 d4 0c 00 00 01 	addl   $0x1,0xcd4
      lock_release(&lock);
 166:	e8 85 02 00 00       	call   3f0 <lock_release>
   for (i = 0; i < loops; i++) {
 16b:	83 c4 10             	add    $0x10,%esp
 16e:	39 1d c8 0c 00 00    	cmp    %ebx,0xcc8
 174:	7f d2                	jg     148 <worker+0x18>
   }
   exit();
 176:	e8 a0 02 00 00       	call   41b <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 76 01 00 00       	call   433 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 39 01 00 00       	call   45b <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 3c 01 00 00       	call   473 <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 02 01 00 00       	call   443 <close>
  return r;
 ...
 4dc:	89 d1                	mov    %edx,%ecx
{
 ...
 509:	0f b6 92 84 09 00 00 	movzbl 0x984(%edx),%edx
 ...
 54e:	56                   	push   %esi
 54f:	57                   	push   %edi
 550:	e8 e6 fe ff ff       	call   43b <write>
  while(--i >= 0)
 ...
 589:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c5:	57                   	push   %edi
 5c6:	56                   	push   %esi
 5c7:	e8 6f fe ff ff       	call   43b <write>
 ...
 5f9:	ff 24 85 2c 09 00 00 	jmp    *0x92c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 61e:	e8 18 fe ff ff       	call   43b <write>
        putc(fd, c);
 ...
 62f:	57                   	push   %edi
 630:	56                   	push   %esi
 631:	e8 05 fe ff ff       	call   43b <write>
        putc(fd, c);
 ...
 69b:	57                   	push   %edi
 69c:	56                   	push   %esi
 69d:	e8 99 fd ff ff       	call   43b <write>
        while(*s != 0){
 ...
 6dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6df:	e8 57 fd ff ff       	call   43b <write>
        ap++;
 ...
 707:	90                   	nop
          s = "(null)";
 708:	ba 22 09 00 00       	mov    $0x922,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 721:	a1 dc 0c 00 00       	mov    0xcdc,%eax
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	89 15 dc 0c 00 00    	mov    %edx,0xcdc
}
 768:	5e                   	pop    %esi
 769:	5f                   	pop    %edi
 76a:	5d                   	pop    %ebp
 ...
 799:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 79c:	89 15 dc 0c 00 00    	mov    %edx,0xcdc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 3d dc 0c 00 00    	mov    0xcdc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 4f                	jae    850 <malloc+0xa0>
    ...
    if(p == freep)
 801:	8b 3d dc 0c 00 00    	mov    0xcdc,%edi
 ...
 813:	e8 8b fc ff ff       	call   4a3 <sbrk>
  if(p == (char*)-1)
 ...
 82a:	e8 f1 fe ff ff       	call   720 <free>
  return freep;
 82f:	8b 15 dc 0c 00 00    	mov    0xcdc,%edx
 ...
 85c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 85f:	89 15 dc 0c 00 00    	mov    %edx,0xcdc
}
 ...
 86f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 dc 0c 00 00 e0 	movl   $0xce0,0xcdc
 877:	0c 00 00 
    base.s.size = 0;
 87a:	bf e0 0c 00 00       	mov    $0xce0,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 e0 0c 00 00 e0 	movl   $0xce0,0xce0
 886:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 88b:	c7 05 e4 0c 00 00 00 	movl   $0x0,0xce4
 892:	00 00 00 
    if(p->s.size >= nunits){
