...
main(void)
{
  ...
  19:	e8 ad 03 00 00       	call   3cb <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 d0 03 00 00       	call   403 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 c4 03 00 00       	call   403 <dup>
  ...
  52:	e8 99 04 00 00       	call   4f0 <printf>
    pid = fork();
  57:	e8 27 03 00 00       	call   383 <fork>
    if(pid < 0){
  ...
  70:	e8 1e 03 00 00       	call   393 <wait>
  ...
  9a:	e8 51 04 00 00       	call   4f0 <printf>
      exit();
  9f:	e8 e7 02 00 00       	call   38b <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 f0 0b 00 00       	push   $0xbf0
  ab:	68 46 08 00 00       	push   $0x846
  b0:	e8 0e 03 00 00       	call   3c3 <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 2d 04 00 00       	call   4f0 <printf>
      exit();
  c3:	e8 c3 02 00 00       	call   38b <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 18 08 00 00       	push   $0x818
  d2:	e8 fc 02 00 00       	call   3d3 <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 18 08 00 00       	push   $0x818
  e0:	e8 e6 02 00 00       	call   3cb <open>
 ...
 219:	31 db                	xor    %ebx,%ebx
{
 ...
 225:	57                   	push   %edi
 226:	6a 00                	push   $0x0
 228:	e8 76 01 00 00       	call   3a3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 39 01 00 00       	call   3cb <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 3c 01 00 00       	call   3e3 <fstat>
  close(fd);
 2a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2aa:	89 c6                	mov    %eax,%esi
  close(fd);
 2ac:	e8 02 01 00 00       	call   3b3 <close>
  return r;
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 535:	57                   	push   %edi
 536:	56                   	push   %esi
 537:	e8 6f fe ff ff       	call   3ab <write>
 ...
 58e:	e8 18 fe ff ff       	call   3ab <write>
        putc(fd, c);
 ...
 59f:	57                   	push   %edi
 5a0:	56                   	push   %esi
 5a1:	e8 05 fe ff ff       	call   3ab <write>
        putc(fd, c);
 ...
 60b:	57                   	push   %edi
 60c:	56                   	push   %esi
 60d:	e8 99 fd ff ff       	call   3ab <write>
        while(*s != 0){
 ...
 64c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 64f:	e8 57 fd ff ff       	call   3ab <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 783:	e8 8b fc ff ff       	call   413 <sbrk>
  if(p == (char*)-1)
