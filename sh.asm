...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 7b 0e 00 00       	call   eab <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 0e 0e 00 00       	call   e63 <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 0c 0e 00 00       	call   e73 <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 d8 0d 00 00       	call   e93 <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 e6 0d 00 00       	call   edb <chdir>
  ...
  exit();
     11a:	e8 4c 0d 00 00       	call   e6b <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 e1 0c 00 00       	call   e6b <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 c8 0c 00 00       	call   e63 <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 c0 0c 00 00       	call   ea3 <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 66 0c 00 00       	call   e6b <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 5c 0c 00 00       	call   e7b <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 44 0c 00 00       	call   e93 <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 3b 0c 00 00       	call   e93 <close>
    wait();
     258:	e8 16 0c 00 00       	call   e73 <wait>
    wait();
     25d:	e8 11 0c 00 00       	call   e73 <wait>
    break;
    ...
    wait();
     270:	e8 fe 0b 00 00       	call   e73 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 08 0c 00 00       	call   e93 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 13 0c 00 00       	call   eab <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 09 0d 00 00       	call   fd0 <printf>
      exit();
     2c7:	e8 9f 0b 00 00       	call   e6b <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 b0 0b 00 00       	call   e93 <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 f7 0b 00 00       	call   ee3 <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 9e 0b 00 00       	call   e93 <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 95 0b 00 00       	call   e93 <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 82 0b 00 00       	call   e93 <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 c9 0b 00 00       	call   ee3 <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 70 0b 00 00       	call   e93 <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 67 0b 00 00       	call   e93 <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 76 01 00 00       	call   e83 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 39 01 00 00       	call   eab <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 3c 01 00 00       	call   ec3 <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 02 01 00 00       	call   e93 <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
	return 0;
     ...
     e22:	c3                   	ret    
     e23:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     e2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00000e30 <lock_acquire>:
...
00000e40 <lock_release>:
     e40:	55                   	push   %ebp
     e41:	89 e5                	mov    %esp,%ebp
     e43:	8b 45 08             	mov    0x8(%ebp),%eax
     e46:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
     e4c:	5d                   	pop    %ebp
     e4d:	c3                   	ret    
...
void lock_init(lock_t * lock){
	...
	lock->state = 0;
     ...
     e56:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
     e5c:	5d                   	pop    %ebp
     e5d:	c3                   	ret    
...
00000e6b <exit>:
SYSCALL(exit)
     e6b:	b8 02 00 00 00       	mov    $0x2,%eax
     e70:	cd 40                	int    $0x40
     e72:	c3                   	ret    

00000e73 <wait>:
SYSCALL(wait)
     e73:	b8 03 00 00 00       	mov    $0x3,%eax
     e78:	cd 40                	int    $0x40
     e7a:	c3                   	ret    

00000e7b <pipe>:
SYSCALL(pipe)
     e7b:	b8 04 00 00 00       	mov    $0x4,%eax
     e80:	cd 40                	int    $0x40
     e82:	c3                   	ret    

00000e83 <read>:
SYSCALL(read)
     e83:	b8 05 00 00 00       	mov    $0x5,%eax
     e88:	cd 40                	int    $0x40
     e8a:	c3                   	ret    

00000e8b <write>:
SYSCALL(write)
     e8b:	b8 10 00 00 00       	mov    $0x10,%eax
     e90:	cd 40                	int    $0x40
     e92:	c3                   	ret    

00000e93 <close>:
SYSCALL(close)
     e93:	b8 15 00 00 00       	mov    $0x15,%eax
     e98:	cd 40                	int    $0x40
     e9a:	c3                   	ret    

00000e9b <kill>:
SYSCALL(kill)
     e9b:	b8 06 00 00 00       	mov    $0x6,%eax
     ea0:	cd 40                	int    $0x40
     ea2:	c3                   	ret    

00000ea3 <exec>:
SYSCALL(exec)
     ea3:	b8 07 00 00 00       	mov    $0x7,%eax
     ea8:	cd 40                	int    $0x40
     eaa:	c3                   	ret    

00000eab <open>:
SYSCALL(open)
     eab:	b8 0f 00 00 00       	mov    $0xf,%eax
     eb0:	cd 40                	int    $0x40
     eb2:	c3                   	ret    

00000eb3 <mknod>:
SYSCALL(mknod)
     eb3:	b8 11 00 00 00       	mov    $0x11,%eax
     eb8:	cd 40                	int    $0x40
     eba:	c3                   	ret    

00000ebb <unlink>:
SYSCALL(unlink)
     ebb:	b8 12 00 00 00       	mov    $0x12,%eax
     ec0:	cd 40                	int    $0x40
     ec2:	c3                   	ret    

00000ec3 <fstat>:
SYSCALL(fstat)
     ec3:	b8 08 00 00 00       	mov    $0x8,%eax
     ec8:	cd 40                	int    $0x40
     eca:	c3                   	ret    

00000ecb <link>:
SYSCALL(link)
     ecb:	b8 13 00 00 00       	mov    $0x13,%eax
     ed0:	cd 40                	int    $0x40
     ed2:	c3                   	ret    

00000ed3 <mkdir>:
SYSCALL(mkdir)
     ed3:	b8 14 00 00 00       	mov    $0x14,%eax
     ed8:	cd 40                	int    $0x40
     eda:	c3                   	ret    

00000edb <chdir>:
SYSCALL(chdir)
     edb:	b8 09 00 00 00       	mov    $0x9,%eax
     ee0:	cd 40                	int    $0x40
     ee2:	c3                   	ret    

00000ee3 <dup>:
SYSCALL(dup)
     ee3:	b8 0a 00 00 00       	mov    $0xa,%eax
     ee8:	cd 40                	int    $0x40
     eea:	c3                   	ret    

00000eeb <getpid>:
SYSCALL(getpid)
     eeb:	b8 0b 00 00 00       	mov    $0xb,%eax
     ef0:	cd 40                	int    $0x40
     ef2:	c3                   	ret    

00000ef3 <sbrk>:
SYSCALL(sbrk)
     ef3:	b8 0c 00 00 00       	mov    $0xc,%eax
     ef8:	cd 40                	int    $0x40
     efa:	c3                   	ret    

00000efb <sleep>:
SYSCALL(sleep)
     efb:	b8 0d 00 00 00       	mov    $0xd,%eax
     f00:	cd 40                	int    $0x40
     f02:	c3                   	ret    

00000f03 <uptime>:
SYSCALL(uptime)
     f03:	b8 0e 00 00 00       	mov    $0xe,%eax
     f08:	cd 40                	int    $0x40
     f0a:	c3                   	ret    

00000f0b <clone>:
SYSCALL(clone)
     f0b:	b8 16 00 00 00       	mov    $0x16,%eax
     f10:	cd 40                	int    $0x40
     f12:	c3                   	ret    

00000f13 <join>:
SYSCALL(join)
     f13:	b8 17 00 00 00       	mov    $0x17,%eax
     f18:	cd 40                	int    $0x40
     f1a:	c3                   	ret    
     ...
     f2c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     f9e:	56                   	push   %esi
     f9f:	57                   	push   %edi
     fa0:	e8 e6 fe ff ff       	call   e8b <write>
  while(--i >= 0)
     ...
     fd9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1015:	57                   	push   %edi
    1016:	56                   	push   %esi
    1017:	e8 6f fe ff ff       	call   e8b <write>
  ...
  write(fd, &c, 1);
    ...
    106e:	e8 18 fe ff ff       	call   e8b <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    107f:	57                   	push   %edi
    1080:	56                   	push   %esi
    1081:	e8 05 fe ff ff       	call   e8b <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10eb:	57                   	push   %edi
    10ec:	56                   	push   %esi
    10ed:	e8 99 fd ff ff       	call   e8b <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    112f:	e8 57 fd ff ff       	call   e8b <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1171:	a1 04 1b 00 00       	mov    0x1b04,%eax
{
  ...
  freep = p;
    ...
    11b1:	5b                   	pop    %ebx
  freep = p;
    11b2:	89 15 04 1b 00 00    	mov    %edx,0x1b04
}
    11b8:	5e                   	pop    %esi
    11b9:	5f                   	pop    %edi
    11ba:	5d                   	pop    %ebp
  ...
  freep = p;
    11ec:	89 15 04 1b 00 00    	mov    %edx,0x1b04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    120c:	8b 3d 04 1b 00 00    	mov    0x1b04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1251:	8b 3d 04 1b 00 00    	mov    0x1b04,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1263:	e8 8b fc ff ff       	call   ef3 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    127f:	8b 15 04 1b 00 00    	mov    0x1b04,%edx
    ...
    12ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    12af:	89 15 04 1b 00 00    	mov    %edx,0x1b04
}
    ...
    12bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    12c0:	c7 05 04 1b 00 00 08 	movl   $0x1b08,0x1b04
    12c7:	1b 00 00 
    base.s.size = 0;
    12ca:	bf 08 1b 00 00       	mov    $0x1b08,%edi
    base.s.ptr = freep = prevp = &base;
    12cf:	c7 05 08 1b 00 00 08 	movl   $0x1b08,0x1b08
    12d6:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    12db:	c7 05 0c 1b 00 00 00 	movl   $0x0,0x1b0c
    12e2:	00 00 00 
    if(p->s.size >= nunits){
