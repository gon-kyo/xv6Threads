...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 af 03 00 00       	call   3eb <open>
  ...
  57:	e8 77 03 00 00       	call   3d3 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 42 03 00 00       	call   3ab <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 98 04 00 00       	call   510 <printf>
      exit();
  78:	e8 2e 03 00 00       	call   3ab <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 1f 03 00 00       	call   3ab <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 1b 03 00 00       	call   3cb <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 f9 02 00 00       	call   3c3 <read>
  ...
  e6:	e8 25 04 00 00       	call   510 <printf>
      exit();
  eb:	e8 bb 02 00 00       	call   3ab <exit>
  ...
  f9:	e8 12 04 00 00       	call   510 <printf>
    exit();
  fe:	e8 a8 02 00 00       	call   3ab <exit>
 ...
 239:	31 db                	xor    %ebx,%ebx
{
 ...
 245:	57                   	push   %edi
 246:	6a 00                	push   $0x0
 248:	e8 76 01 00 00       	call   3c3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 39 01 00 00       	call   3eb <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 3c 01 00 00       	call   403 <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 02 01 00 00       	call   3d3 <close>
  return r;
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 555:	57                   	push   %edi
 556:	56                   	push   %esi
 557:	e8 6f fe ff ff       	call   3cb <write>
 ...
 5ae:	e8 18 fe ff ff       	call   3cb <write>
        putc(fd, c);
 ...
 5bf:	57                   	push   %edi
 5c0:	56                   	push   %esi
 5c1:	e8 05 fe ff ff       	call   3cb <write>
        putc(fd, c);
 ...
 62b:	57                   	push   %edi
 62c:	56                   	push   %esi
 62d:	e8 99 fd ff ff       	call   3cb <write>
        while(*s != 0){
 ...
 66c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 66f:	e8 57 fd ff ff       	call   3cb <write>
        ap++;
...
free(void *ap)
{
 ...
 6b1:	a1 40 0e 00 00       	mov    0xe40,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 40 0e 00 00    	mov    %edx,0xe40
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 40 0e 00 00    	mov    %edx,0xe40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 40 0e 00 00    	mov    0xe40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d 40 0e 00 00    	mov    0xe40,%edi
 ...
 7a3:	e8 8b fc ff ff       	call   433 <sbrk>
  if(p == (char*)-1)
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 40 0e 00 00    	mov    0xe40,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 40 0e 00 00    	mov    %edx,0xe40
}
