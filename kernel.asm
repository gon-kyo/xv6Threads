...
80102088:	68 c6 79 10 80       	push   $0x801079c6
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 2f 59 10 80 	movl   $0x8010592f,0x14(%eax)
  p->context = (struct context*)sp;
...
801038e0:	e8 0b 0b 00 00       	call   801043f0 <initlock>
}
...
80103945:	68 a4 78 10 80       	push   $0x801078a4
...
80103974:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103977:	e8 f4 0a 00 00       	call   80104470 <pushcli>
  c = mycpu();
8010397c:	e8 6f ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103981:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103987:	e8 34 0b 00 00       	call   801044c0 <popcli>
}
...
801039d3:	e8 48 35 00 00       	call   80106f20 <setupkvm>
...
801039f1:	e8 da 31 00 00       	call   80106bd0 <inituvm>
...
80103a5f:	68 f0 77 10 80       	push   $0x801077f0
80103a64:	50                   	push   %eax
80103a65:	e8 d6 0d 00 00       	call   80104840 <safestrcpy>
  p->cwd = namei("/");
80103a6a:	c7 04 24 f9 77 10 80 	movl   $0x801077f9,(%esp)
...
80103aa3:	68 d7 77 10 80       	push   $0x801077d7
...
80103ab8:	e8 b3 09 00 00       	call   80104470 <pushcli>
  c = mycpu();
80103abd:	e8 2e fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80103adb:	e8 e0 2f 00 00       	call   80106ac0 <switchuvm>
  return 0;
...
80103afa:	e8 41 32 00 00       	call   80106d40 <allocuvm>
...
80103b1a:	e8 51 33 00 00       	call   80106e70 <deallocuvm>
...
80103b39:	e8 32 09 00 00       	call   80104470 <pushcli>
  c = mycpu();
80103b3e:	e8 ad fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80103b68:	e8 a3 34 00 00       	call   80107010 <copyuvm>
...
80103c56:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103c59:	e8 92 fc ff ff       	call   801038f0 <mycpu>
  c->proc = 0;
...
80103ca0:	e8 1b 2e 00 00       	call   80106ac0 <switchuvm>
...
80103cb2:	e8 e4 0b 00 00       	call   8010489b <swtch>
      switchkvm();
80103cb7:	e8 f4 2d 00 00       	call   80106ab0 <switchkvm>
      c->proc = 0;
...
80103cf5:	e8 76 07 00 00       	call   80104470 <pushcli>
  c = mycpu();
80103cfa:	e8 f1 fb ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80103d37:	75 41                	jne    80103d7a <sched+0x8a>
  intena = mycpu()->intena;
80103d39:	e8 b2 fb ff ff       	call   801038f0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103d3e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103d41:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d47:	e8 a4 fb ff ff       	call   801038f0 <mycpu>
...
80103d53:	e8 43 0b 00 00       	call   8010489b <swtch>
  mycpu()->intena = intena;
80103d58:	e8 93 fb ff ff       	call   801038f0 <mycpu>
}
...
80103db6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103db9:	e8 b2 fb ff ff       	call   80103970 <myproc>
  if(curproc == initproc)
...
80103ebd:	68 48 78 10 80       	push   $0x80107848
80103ec2:	e8 b9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ec7:	83 ec 0c             	sub    $0xc,%esp
80103eca:	68 3b 78 10 80       	push   $0x8010783b
...
80103ee5:	e8 86 05 00 00       	call   80104470 <pushcli>
  c = mycpu();
80103eea:	e8 01 fa ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80103f51:	e8 1a 05 00 00       	call   80104470 <pushcli>
  c = mycpu();
80103f56:	e8 95 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80103fa9:	e8 f2 2e 00 00       	call   80106ea0 <freevm>
        p->pid = 0;
...
80104000:	68 54 78 10 80       	push   $0x80107854
...
80104021:	e8 4a 04 00 00       	call   80104470 <pushcli>
  c = mycpu();
80104026:	e8 c5 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80104109:	68 5a 78 10 80       	push   $0x8010785a
8010410e:	e8 6d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104113:	83 ec 0c             	sub    $0xc,%esp
80104116:	68 54 78 10 80       	push   $0x80107854
...
8010421b:	68 df 7b 10 80       	push   $0x80107bdf
...
8010423c:	74 ea                	je     80104228 <procdump+0x28>
      state = "???";
8010423e:	ba 6b 78 10 80       	mov    $0x8010786b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104243:	83 f8 05             	cmp    $0x5,%eax
80104246:	77 11                	ja     80104259 <procdump+0x59>
80104248:	8b 14 85 cc 78 10 80 	mov    -0x7fef8734(,%eax,4),%edx
      state = "???";
8010424f:	b8 6b 78 10 80       	mov    $0x8010786b,%eax
...
8010425e:	68 6f 78 10 80       	push   $0x8010786f
...
8010429d:	68 c1 72 10 80       	push   $0x801072c1
...
801042ca:	68 e4 78 10 80       	push   $0x801078e4
...
80104333:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104339:	e8 32 f6 ff ff       	call   80103970 <myproc>
...
801043db:	e8 90 f5 ff ff       	call   80103970 <myproc>
...
8010449a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801044a0:	e8 4b f4 ff ff       	call   801038f0 <mycpu>
...
80104505:	68 ef 78 10 80       	push   $0x801078ef
8010450a:	e8 71 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010450f:	83 ec 0c             	sub    $0xc,%esp
80104512:	68 06 79 10 80       	push   $0x80107906
...
80104543:	e8 a8 f3 ff ff       	call   801038f0 <mycpu>
...
801045fc:	e8 ef f2 ff ff       	call   801038f0 <mycpu>
...
80104670:	68 15 79 10 80       	push   $0x80107915
...
801048b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801048ba:	e8 b1 f0 ff ff       	call   80103970 <myproc>
...
801048f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801048fa:	e8 71 f0 ff ff       	call   80103970 <myproc>
...
80104945:	e8 26 f0 ff ff       	call   80103970 <myproc>
...
80104953:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104956:	e8 15 f0 ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104996:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104999:	e8 d2 ef ff ff       	call   80103970 <myproc>
8010499e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801049a0:	e8 cb ef ff ff       	call   80103970 <myproc>
...
801049ae:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049b1:	e8 ba ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a84:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a87:	e8 e4 ee ff ff       	call   80103970 <myproc>
...
80104a9c:	8b 14 85 40 79 10 80 	mov    -0x7fef86c0(,%eax,4),%edx
...
80104ac8:	68 1d 79 10 80       	push   $0x8010791d
...
80104c24:	68 bc 79 10 80       	push   $0x801079bc
...
80104c3c:	68 bb 79 10 80       	push   $0x801079bb
...
80104c51:	68 af 79 10 80       	push   $0x801079af
...
80104c6f:	68 be 79 10 80       	push   $0x801079be
80104c74:	e8 07 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c79:	83 ec 0c             	sub    $0xc,%esp
80104c7c:	68 a0 79 10 80       	push   $0x801079a0
...
8010507d:	58                   	pop    %eax
8010507e:	5a                   	pop    %edx
8010507f:	68 bc 79 10 80       	push   $0x801079bc
...
80105098:	68 bb 79 10 80       	push   $0x801079bb
...
80105863:	83 ec 1c             	sub    $0x1c,%esp
	void* func;
	void* arg1;
	void* arg2;
	void* stack;
...
801058b3:	e8 d8 f0 ff ff       	call   80104990 <argptr>
801058b8:	83 c4 10             	add    $0x10,%esp
801058bb:	85 c0                	test   %eax,%eax
801058bd:	78 19                	js     801058d8 <sys_clone+0x78>
		return -1;
	}
	
	return clone(func, arg1, arg2, stack);
801058bf:	ff 75 f4             	push   -0xc(%ebp)
801058c2:	ff 75 f0             	push   -0x10(%ebp)
801058c5:	ff 75 ec             	push   -0x14(%ebp)
801058c8:	ff 75 e8             	push   -0x18(%ebp)
801058cb:	e8 d0 e0 ff ff       	call   801039a0 <clone>
...
801058ee:	e8 9d f0 ff ff       	call   80104990 <argptr>
801058f3:	83 c4 10             	add    $0x10,%esp
801058f6:	85 c0                	test   %eax,%eax
801058f8:	78 16                	js     80105910 <sys_join+0x30>
		return -1;
	}
	return join(stack);
801058fa:	83 ec 0c             	sub    $0xc,%esp
801058fd:	ff 75 f4             	push   -0xc(%ebp)
80105900:	e8 ab e0 ff ff       	call   801039b0 <join>
...
801059a4:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
801059aa:	e8 41 ea ff ff       	call   801043f0 <initlock>
}
...
80105b24:	0f 85 3e ff ff ff    	jne    80105a68 <trap+0x78>
    yield();
80105b2a:	e8 e1 e4 ff ff       	call   80104010 <yield>
...
80105b85:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b88:	e8 f3 ee ff ff       	call   80104a80 <syscall>
    if(myproc()->killed)
...
80105ba3:	5d                   	pop    %ebp
      exit();
80105ba4:	e9 07 e2 ff ff       	jmp    80103db0 <exit>
...
80105e07:	6a 00                	push   $0x0
  jmp alltraps
80105e09:	e9 09 fb ff ff       	jmp    80105917 <alltraps>
...
80105e10:	6a 01                	push   $0x1
  jmp alltraps
80105e12:	e9 00 fb ff ff       	jmp    80105917 <alltraps>
...
80105e19:	6a 02                	push   $0x2
  jmp alltraps
80105e1b:	e9 f7 fa ff ff       	jmp    80105917 <alltraps>
...
80105e22:	6a 03                	push   $0x3
  jmp alltraps
80105e24:	e9 ee fa ff ff       	jmp    80105917 <alltraps>
...
80105e2b:	6a 04                	push   $0x4
  jmp alltraps
80105e2d:	e9 e5 fa ff ff       	jmp    80105917 <alltraps>
...
80105e64:	6a 0b                	push   $0xb
  jmp alltraps
80105e66:	e9 ac fa ff ff       	jmp    80105917 <alltraps>
...
80105e9b:	6a 12                	push   $0x12
  jmp alltraps
80105e9d:	e9 75 fa ff ff       	jmp    80105917 <alltraps>
...
80105ea4:	6a 13                	push   $0x13
  jmp alltraps
80105ea6:	e9 6c fa ff ff       	jmp    80105917 <alltraps>
...
80105ebf:	6a 16                	push   $0x16
  jmp alltraps
80105ec1:	e9 51 fa ff ff       	jmp    80105917 <alltraps>
...
80105ec8:	6a 17                	push   $0x17
  jmp alltraps
80105eca:	e9 48 fa ff ff       	jmp    80105917 <alltraps>
...
80105ed1:	6a 18                	push   $0x18
  jmp alltraps
80105ed3:	e9 3f fa ff ff       	jmp    80105917 <alltraps>
...
80105eda:	6a 19                	push   $0x19
  jmp alltraps
80105edc:	e9 36 fa ff ff       	jmp    80105917 <alltraps>
...
80105ee3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ee5:	e9 2d fa ff ff       	jmp    80105917 <alltraps>
...
80105eec:	6a 1b                	push   $0x1b
  jmp alltraps
80105eee:	e9 24 fa ff ff       	jmp    80105917 <alltraps>
...
80105ef5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ef7:	e9 1b fa ff ff       	jmp    80105917 <alltraps>
...
80105efe:	6a 1d                	push   $0x1d
  jmp alltraps
80105f00:	e9 12 fa ff ff       	jmp    80105917 <alltraps>
...
80105f07:	6a 1e                	push   $0x1e
  jmp alltraps
80105f09:	e9 09 fa ff ff       	jmp    80105917 <alltraps>
...
80105f10:	6a 1f                	push   $0x1f
  jmp alltraps
80105f12:	e9 00 fa ff ff       	jmp    80105917 <alltraps>
...
80105f19:	6a 20                	push   $0x20
  jmp alltraps
80105f1b:	e9 f7 f9 ff ff       	jmp    80105917 <alltraps>
...
80105f22:	6a 21                	push   $0x21
  jmp alltraps
80105f24:	e9 ee f9 ff ff       	jmp    80105917 <alltraps>
...
80105f2b:	6a 22                	push   $0x22
  jmp alltraps
80105f2d:	e9 e5 f9 ff ff       	jmp    80105917 <alltraps>
...
80105f34:	6a 23                	push   $0x23
  jmp alltraps
80105f36:	e9 dc f9 ff ff       	jmp    80105917 <alltraps>
...
80105f3d:	6a 24                	push   $0x24
  jmp alltraps
80105f3f:	e9 d3 f9 ff ff       	jmp    80105917 <alltraps>
...
80105f46:	6a 25                	push   $0x25
  jmp alltraps
80105f48:	e9 ca f9 ff ff       	jmp    80105917 <alltraps>
...
80105f4f:	6a 26                	push   $0x26
  jmp alltraps
80105f51:	e9 c1 f9 ff ff       	jmp    80105917 <alltraps>
...
80105f58:	6a 27                	push   $0x27
  jmp alltraps
80105f5a:	e9 b8 f9 ff ff       	jmp    80105917 <alltraps>
...
80105f61:	6a 28                	push   $0x28
  jmp alltraps
80105f63:	e9 af f9 ff ff       	jmp    80105917 <alltraps>
...
80105f6a:	6a 29                	push   $0x29
  jmp alltraps
80105f6c:	e9 a6 f9 ff ff       	jmp    80105917 <alltraps>
...
80105f73:	6a 2a                	push   $0x2a
  jmp alltraps
80105f75:	e9 9d f9 ff ff       	jmp    80105917 <alltraps>
...
80105f7c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f7e:	e9 94 f9 ff ff       	jmp    80105917 <alltraps>
...
80105f85:	6a 2c                	push   $0x2c
  jmp alltraps
80105f87:	e9 8b f9 ff ff       	jmp    80105917 <alltraps>
...
80105f8e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f90:	e9 82 f9 ff ff       	jmp    80105917 <alltraps>
...
80105f97:	6a 2e                	push   $0x2e
  jmp alltraps
80105f99:	e9 79 f9 ff ff       	jmp    80105917 <alltraps>
...
80105fa0:	6a 2f                	push   $0x2f
  jmp alltraps
80105fa2:	e9 70 f9 ff ff       	jmp    80105917 <alltraps>
...
80105fa9:	6a 30                	push   $0x30
  jmp alltraps
80105fab:	e9 67 f9 ff ff       	jmp    80105917 <alltraps>
...
80105fb2:	6a 31                	push   $0x31
  jmp alltraps
80105fb4:	e9 5e f9 ff ff       	jmp    80105917 <alltraps>
...
80105fbb:	6a 32                	push   $0x32
  jmp alltraps
80105fbd:	e9 55 f9 ff ff       	jmp    80105917 <alltraps>
...
80105fc4:	6a 33                	push   $0x33
  jmp alltraps
80105fc6:	e9 4c f9 ff ff       	jmp    80105917 <alltraps>
...
80105fcd:	6a 34                	push   $0x34
  jmp alltraps
80105fcf:	e9 43 f9 ff ff       	jmp    80105917 <alltraps>
...
80105fd6:	6a 35                	push   $0x35
  jmp alltraps
80105fd8:	e9 3a f9 ff ff       	jmp    80105917 <alltraps>
...
80105fdf:	6a 36                	push   $0x36
  jmp alltraps
80105fe1:	e9 31 f9 ff ff       	jmp    80105917 <alltraps>
...
80105fe8:	6a 37                	push   $0x37
  jmp alltraps
80105fea:	e9 28 f9 ff ff       	jmp    80105917 <alltraps>
...
80105ff1:	6a 38                	push   $0x38
  jmp alltraps
80105ff3:	e9 1f f9 ff ff       	jmp    80105917 <alltraps>
...
80105ffa:	6a 39                	push   $0x39
  jmp alltraps
80105ffc:	e9 16 f9 ff ff       	jmp    80105917 <alltraps>
...
80106003:	6a 3a                	push   $0x3a
  jmp alltraps
80106005:	e9 0d f9 ff ff       	jmp    80105917 <alltraps>
...
8010600c:	6a 3b                	push   $0x3b
  jmp alltraps
8010600e:	e9 04 f9 ff ff       	jmp    80105917 <alltraps>
...
80106015:	6a 3c                	push   $0x3c
  jmp alltraps
80106017:	e9 fb f8 ff ff       	jmp    80105917 <alltraps>
...
8010601e:	6a 3d                	push   $0x3d
  jmp alltraps
80106020:	e9 f2 f8 ff ff       	jmp    80105917 <alltraps>
...
80106027:	6a 3e                	push   $0x3e
  jmp alltraps
80106029:	e9 e9 f8 ff ff       	jmp    80105917 <alltraps>
...
80106030:	6a 3f                	push   $0x3f
  jmp alltraps
80106032:	e9 e0 f8 ff ff       	jmp    80105917 <alltraps>
...
80106039:	6a 40                	push   $0x40
  jmp alltraps
8010603b:	e9 d7 f8 ff ff       	jmp    80105917 <alltraps>
...
80106042:	6a 41                	push   $0x41
  jmp alltraps
80106044:	e9 ce f8 ff ff       	jmp    80105917 <alltraps>
...
8010604b:	6a 42                	push   $0x42
  jmp alltraps
8010604d:	e9 c5 f8 ff ff       	jmp    80105917 <alltraps>
...
80106054:	6a 43                	push   $0x43
  jmp alltraps
80106056:	e9 bc f8 ff ff       	jmp    80105917 <alltraps>
...
8010605d:	6a 44                	push   $0x44
  jmp alltraps
8010605f:	e9 b3 f8 ff ff       	jmp    80105917 <alltraps>
...
80106066:	6a 45                	push   $0x45
  jmp alltraps
80106068:	e9 aa f8 ff ff       	jmp    80105917 <alltraps>
...
8010606f:	6a 46                	push   $0x46
  jmp alltraps
80106071:	e9 a1 f8 ff ff       	jmp    80105917 <alltraps>
...
80106078:	6a 47                	push   $0x47
  jmp alltraps
8010607a:	e9 98 f8 ff ff       	jmp    80105917 <alltraps>
...
80106081:	6a 48                	push   $0x48
  jmp alltraps
80106083:	e9 8f f8 ff ff       	jmp    80105917 <alltraps>
...
8010608a:	6a 49                	push   $0x49
  jmp alltraps
8010608c:	e9 86 f8 ff ff       	jmp    80105917 <alltraps>
...
80106093:	6a 4a                	push   $0x4a
  jmp alltraps
80106095:	e9 7d f8 ff ff       	jmp    80105917 <alltraps>
...
8010609c:	6a 4b                	push   $0x4b
  jmp alltraps
8010609e:	e9 74 f8 ff ff       	jmp    80105917 <alltraps>
...
801060a5:	6a 4c                	push   $0x4c
  jmp alltraps
801060a7:	e9 6b f8 ff ff       	jmp    80105917 <alltraps>
...
801060ae:	6a 4d                	push   $0x4d
  jmp alltraps
801060b0:	e9 62 f8 ff ff       	jmp    80105917 <alltraps>
...
801060b7:	6a 4e                	push   $0x4e
  jmp alltraps
801060b9:	e9 59 f8 ff ff       	jmp    80105917 <alltraps>
...
801060c0:	6a 4f                	push   $0x4f
  jmp alltraps
801060c2:	e9 50 f8 ff ff       	jmp    80105917 <alltraps>
...
801060c9:	6a 50                	push   $0x50
  jmp alltraps
801060cb:	e9 47 f8 ff ff       	jmp    80105917 <alltraps>
...
801060d2:	6a 51                	push   $0x51
  jmp alltraps
801060d4:	e9 3e f8 ff ff       	jmp    80105917 <alltraps>
...
801060db:	6a 52                	push   $0x52
  jmp alltraps
801060dd:	e9 35 f8 ff ff       	jmp    80105917 <alltraps>
...
801060e4:	6a 53                	push   $0x53
  jmp alltraps
801060e6:	e9 2c f8 ff ff       	jmp    80105917 <alltraps>
...
801060ed:	6a 54                	push   $0x54
  jmp alltraps
801060ef:	e9 23 f8 ff ff       	jmp    80105917 <alltraps>
...
801060f6:	6a 55                	push   $0x55
  jmp alltraps
801060f8:	e9 1a f8 ff ff       	jmp    80105917 <alltraps>
...
801060ff:	6a 56                	push   $0x56
  jmp alltraps
80106101:	e9 11 f8 ff ff       	jmp    80105917 <alltraps>
...
80106108:	6a 57                	push   $0x57
  jmp alltraps
8010610a:	e9 08 f8 ff ff       	jmp    80105917 <alltraps>
...
80106111:	6a 58                	push   $0x58
  jmp alltraps
80106113:	e9 ff f7 ff ff       	jmp    80105917 <alltraps>
...
8010611a:	6a 59                	push   $0x59
  jmp alltraps
8010611c:	e9 f6 f7 ff ff       	jmp    80105917 <alltraps>
...
80106123:	6a 5a                	push   $0x5a
  jmp alltraps
80106125:	e9 ed f7 ff ff       	jmp    80105917 <alltraps>
...
8010612c:	6a 5b                	push   $0x5b
  jmp alltraps
8010612e:	e9 e4 f7 ff ff       	jmp    80105917 <alltraps>
...
80106135:	6a 5c                	push   $0x5c
  jmp alltraps
80106137:	e9 db f7 ff ff       	jmp    80105917 <alltraps>
...
8010613e:	6a 5d                	push   $0x5d
  jmp alltraps
80106140:	e9 d2 f7 ff ff       	jmp    80105917 <alltraps>
...
80106147:	6a 5e                	push   $0x5e
  jmp alltraps
80106149:	e9 c9 f7 ff ff       	jmp    80105917 <alltraps>
...
80106150:	6a 5f                	push   $0x5f
  jmp alltraps
80106152:	e9 c0 f7 ff ff       	jmp    80105917 <alltraps>
...
80106159:	6a 60                	push   $0x60
  jmp alltraps
8010615b:	e9 b7 f7 ff ff       	jmp    80105917 <alltraps>
...
80106162:	6a 61                	push   $0x61
  jmp alltraps
80106164:	e9 ae f7 ff ff       	jmp    80105917 <alltraps>
...
8010616b:	6a 62                	push   $0x62
  jmp alltraps
8010616d:	e9 a5 f7 ff ff       	jmp    80105917 <alltraps>
...
80106174:	6a 63                	push   $0x63
  jmp alltraps
80106176:	e9 9c f7 ff ff       	jmp    80105917 <alltraps>
...
8010617d:	6a 64                	push   $0x64
  jmp alltraps
8010617f:	e9 93 f7 ff ff       	jmp    80105917 <alltraps>
...
80106186:	6a 65                	push   $0x65
  jmp alltraps
80106188:	e9 8a f7 ff ff       	jmp    80105917 <alltraps>
...
8010618f:	6a 66                	push   $0x66
  jmp alltraps
80106191:	e9 81 f7 ff ff       	jmp    80105917 <alltraps>
...
80106198:	6a 67                	push   $0x67
  jmp alltraps
8010619a:	e9 78 f7 ff ff       	jmp    80105917 <alltraps>
...
801061a1:	6a 68                	push   $0x68
  jmp alltraps
801061a3:	e9 6f f7 ff ff       	jmp    80105917 <alltraps>
...
801061aa:	6a 69                	push   $0x69
  jmp alltraps
801061ac:	e9 66 f7 ff ff       	jmp    80105917 <alltraps>
...
801061b3:	6a 6a                	push   $0x6a
  jmp alltraps
801061b5:	e9 5d f7 ff ff       	jmp    80105917 <alltraps>
...
801061bc:	6a 6b                	push   $0x6b
  jmp alltraps
801061be:	e9 54 f7 ff ff       	jmp    80105917 <alltraps>
...
801061c5:	6a 6c                	push   $0x6c
  jmp alltraps
801061c7:	e9 4b f7 ff ff       	jmp    80105917 <alltraps>
...
801061ce:	6a 6d                	push   $0x6d
  jmp alltraps
801061d0:	e9 42 f7 ff ff       	jmp    80105917 <alltraps>
...
801061d7:	6a 6e                	push   $0x6e
  jmp alltraps
801061d9:	e9 39 f7 ff ff       	jmp    80105917 <alltraps>
...
801061e0:	6a 6f                	push   $0x6f
  jmp alltraps
801061e2:	e9 30 f7 ff ff       	jmp    80105917 <alltraps>
...
801061e9:	6a 70                	push   $0x70
  jmp alltraps
801061eb:	e9 27 f7 ff ff       	jmp    80105917 <alltraps>
...
801061f2:	6a 71                	push   $0x71
  jmp alltraps
801061f4:	e9 1e f7 ff ff       	jmp    80105917 <alltraps>
...
801061fb:	6a 72                	push   $0x72
  jmp alltraps
801061fd:	e9 15 f7 ff ff       	jmp    80105917 <alltraps>
...
80106204:	6a 73                	push   $0x73
  jmp alltraps
80106206:	e9 0c f7 ff ff       	jmp    80105917 <alltraps>
...
8010620d:	6a 74                	push   $0x74
  jmp alltraps
8010620f:	e9 03 f7 ff ff       	jmp    80105917 <alltraps>
...
80106216:	6a 75                	push   $0x75
  jmp alltraps
80106218:	e9 fa f6 ff ff       	jmp    80105917 <alltraps>
...
8010621f:	6a 76                	push   $0x76
  jmp alltraps
80106221:	e9 f1 f6 ff ff       	jmp    80105917 <alltraps>
...
80106228:	6a 77                	push   $0x77
  jmp alltraps
8010622a:	e9 e8 f6 ff ff       	jmp    80105917 <alltraps>
...
80106231:	6a 78                	push   $0x78
  jmp alltraps
80106233:	e9 df f6 ff ff       	jmp    80105917 <alltraps>
...
8010623a:	6a 79                	push   $0x79
  jmp alltraps
8010623c:	e9 d6 f6 ff ff       	jmp    80105917 <alltraps>
...
80106243:	6a 7a                	push   $0x7a
  jmp alltraps
80106245:	e9 cd f6 ff ff       	jmp    80105917 <alltraps>
...
80106255:	6a 7c                	push   $0x7c
  jmp alltraps
80106257:	e9 bb f6 ff ff       	jmp    80105917 <alltraps>
...
8010625e:	6a 7d                	push   $0x7d
  jmp alltraps
80106260:	e9 b2 f6 ff ff       	jmp    80105917 <alltraps>
...
80106267:	6a 7e                	push   $0x7e
  jmp alltraps
80106269:	e9 a9 f6 ff ff       	jmp    80105917 <alltraps>
...
801069c5:	e8 b6 dc ff ff       	call   80104680 <memset>
...
80106ae4:	0f 84 c2 00 00 00    	je     80106bac <switchuvm+0xec>
  pushcli();
80106aea:	e8 81 d9 ff ff       	call   80104470 <pushcli>
...
80106bff:	e8 7c da ff ff       	call   80104680 <memset>
...
80106c32:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c33:	e9 e8 da ff ff       	jmp    80104720 <memmove>
...
80106d8b:	e8 f0 d8 ff ff       	call   80104680 <memset>
...
80106f40:	e8 3b d7 ff ff       	call   80104680 <memset>
...
801070b0:	e8 6b d6 ff ff       	call   80104720 <memmove>
...
801071e0:	e8 3b d5 ff ff       	call   80104720 <memmove>
    len -= n;
    buf += n;
