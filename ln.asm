   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 3b 04 00 00       	call   460 <printf>
    exit();
  25:	e8 d1 02 00 00       	call   2fb <exit>
  }
  ...
  32:	e8 24 03 00 00       	call   35b <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 b8 02 00 00       	call   2fb <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 76 01 00 00       	call   313 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 39 01 00 00       	call   33b <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 3c 01 00 00       	call   353 <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 02 01 00 00       	call   323 <close>
  return r;
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	56                   	push   %esi
 4a7:	e8 6f fe ff ff       	call   31b <write>
 ...
 4fe:	e8 18 fe ff ff       	call   31b <write>
        putc(fd, c);
 ...
 50f:	57                   	push   %edi
 510:	56                   	push   %esi
 511:	e8 05 fe ff ff       	call   31b <write>
        putc(fd, c);
 ...
 57b:	57                   	push   %edi
 57c:	56                   	push   %esi
 57d:	e8 99 fd ff ff       	call   31b <write>
        while(*s != 0){
 ...
 5bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5bf:	e8 57 fd ff ff       	call   31b <write>
        ap++;
...
free(void *ap)
{
 ...
 601:	a1 38 0b 00 00       	mov    0xb38,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 38 0b 00 00    	mov    %edx,0xb38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
 ...
 6f3:	e8 8b fc ff ff       	call   383 <sbrk>
  if(p == (char*)-1)
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 38 0b 00 00    	mov    0xb38,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 38 0b 00 00 3c 	movl   $0xb3c,0xb38
 757:	0b 00 00 
    base.s.size = 0;
 75a:	bf 3c 0b 00 00       	mov    $0xb3c,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 766:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 772:	00 00 00 
    if(p->s.size >= nunits){
