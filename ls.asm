...
main(int argc, char *argv[])
{
  ...
  exit();
  3d:	e8 99 05 00 00       	call   5db <exit>
    ls(".");
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	68 b0 0a 00 00       	push   $0xab0
  4a:	e8 b1 00 00 00       	call   100 <ls>
    exit();
  4f:	e8 87 05 00 00       	call   5db <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 04 05 00 00       	call   61b <open>
 ...
 12d:	56                   	push   %esi
 12e:	50                   	push   %eax
 12f:	e8 ff 04 00 00       	call   633 <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 a8 04 00 00       	call   603 <close>
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 e1 03 00 00       	call   5f3 <read>
 ...
 313:	e8 eb 02 00 00       	call   603 <close>
    return;
 ...
 469:	31 db                	xor    %ebx,%ebx
{
 ...
 475:	57                   	push   %edi
 476:	6a 00                	push   $0x0
 478:	e8 76 01 00 00       	call   5f3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4dd:	e8 39 01 00 00       	call   61b <open>
  if(fd < 0)
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 3c 01 00 00       	call   633 <fstat>
  close(fd);
 4f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4fa:	89 c6                	mov    %eax,%esi
  close(fd);
 4fc:	e8 02 01 00 00       	call   603 <close>
  return r;
...
00000683 <join>:
SYSCALL(join)
 683:	b8 17 00 00 00       	mov    $0x17,%eax
 688:	cd 40                	int    $0x40
 68a:	c3                   	ret    
 ...
 69c:	89 d1                	mov    %edx,%ecx
{
 ...
 70e:	56                   	push   %esi
 70f:	57                   	push   %edi
 710:	e8 e6 fe ff ff       	call   5fb <write>
  while(--i >= 0)
 ...
 749:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 785:	57                   	push   %edi
 786:	56                   	push   %esi
 787:	e8 6f fe ff ff       	call   5fb <write>
 ...
 7de:	e8 18 fe ff ff       	call   5fb <write>
        putc(fd, c);
 ...
 7ef:	57                   	push   %edi
 7f0:	56                   	push   %esi
 7f1:	e8 05 fe ff ff       	call   5fb <write>
        putc(fd, c);
 ...
 85b:	57                   	push   %edi
 85c:	56                   	push   %esi
 85d:	e8 99 fd ff ff       	call   5fb <write>
        while(*s != 0){
 ...
 89c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 89f:	e8 57 fd ff ff       	call   5fb <write>
        ap++;
 ...
 8e1:	a1 d0 0e 00 00       	mov    0xed0,%eax
{
 ...
 921:	5b                   	pop    %ebx
  freep = p;
 922:	89 15 d0 0e 00 00    	mov    %edx,0xed0
}
 928:	5e                   	pop    %esi
 929:	5f                   	pop    %edi
 92a:	5d                   	pop    %ebp
 ...
 959:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 95c:	89 15 d0 0e 00 00    	mov    %edx,0xed0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 3d d0 0e 00 00    	mov    0xed0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9bf:	73 4f                	jae    a10 <malloc+0xa0>
    ...
    if(p == freep)
 9c1:	8b 3d d0 0e 00 00    	mov    0xed0,%edi
 ...
 9d3:	e8 8b fc ff ff       	call   663 <sbrk>
  if(p == (char*)-1)
 ...
 9ea:	e8 f1 fe ff ff       	call   8e0 <free>
  return freep;
 9ef:	8b 15 d0 0e 00 00    	mov    0xed0,%edx
 ...
 a1c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a1f:	89 15 d0 0e 00 00    	mov    %edx,0xed0
}
 ...
 a2f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a30:	c7 05 d0 0e 00 00 d4 	movl   $0xed4,0xed0
 a37:	0e 00 00 
    base.s.size = 0;
 a3a:	bf d4 0e 00 00       	mov    $0xed4,%edi
    base.s.ptr = freep = prevp = &base;
 a3f:	c7 05 d4 0e 00 00 d4 	movl   $0xed4,0xed4
 a46:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a49:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a4b:	c7 05 d8 0e 00 00 00 	movl   $0x0,0xed8
 a52:	00 00 00 
    if(p->s.size >= nunits){
