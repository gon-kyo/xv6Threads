...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 a1 02 00 00       	call   30b <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 76 01 00 00       	call   323 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 39 01 00 00       	call   34b <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 3c 01 00 00       	call   363 <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 02 01 00 00       	call   333 <close>
  return r;
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 43e:	56                   	push   %esi
 43f:	57                   	push   %edi
 440:	e8 e6 fe ff ff       	call   32b <write>
  while(--i >= 0)
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b5:	57                   	push   %edi
 4b6:	56                   	push   %esi
 4b7:	e8 6f fe ff ff       	call   32b <write>
 ...
 50e:	e8 18 fe ff ff       	call   32b <write>
        putc(fd, c);
 ...
 51f:	57                   	push   %edi
 520:	56                   	push   %esi
 521:	e8 05 fe ff ff       	call   32b <write>
        putc(fd, c);
 ...
 58b:	57                   	push   %edi
 58c:	56                   	push   %esi
 58d:	e8 99 fd ff ff       	call   32b <write>
        while(*s != 0){
 ...
 5cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5cf:	e8 57 fd ff ff       	call   32b <write>
        ap++;
...
free(void *ap)
{
 ...
 611:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 30 0b 00 00    	mov    %edx,0xb30
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 30 0b 00 00    	mov    %edx,0xb30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
 ...
 703:	e8 8b fc ff ff       	call   393 <sbrk>
  if(p == (char*)-1)
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 30 0b 00 00    	mov    %edx,0xb30
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 34 0b 00 00       	mov    $0xb34,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 776:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 782:	00 00 00 
    if(p->s.size >= nunits){
