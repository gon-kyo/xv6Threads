...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 31 03 00 00       	call   36b <unlink>
...
free(void *ap)
{
 ...
 621:	a1 68 0b 00 00       	mov    0xb68,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 68 0b 00 00    	mov    %edx,0xb68
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 68 0b 00 00    	mov    %edx,0xb68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 68 0b 00 00    	mov    0xb68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 68 0b 00 00    	mov    0xb68,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 68 0b 00 00    	mov    0xb68,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 68 0b 00 00    	mov    %edx,0xb68
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 68 0b 00 00 6c 	movl   $0xb6c,0xb68
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 6c 0b 00 00       	mov    $0xb6c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 70 0b 00 00 00 	movl   $0x0,0xb70
 792:	00 00 00 
    if(p->s.size >= nunits){
