  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 70 03 00 00       	call   3d3 <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 73 03 00 00       	call   41b <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 3c 03 00 00       	call   3fb <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 33 03 00 00       	call   403 <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 28 03 00 00       	call   41b <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 e4 02 00 00       	call   3f3 <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 e3 02 00 00       	call   403 <close>

  wait();
 120:	e8 be 02 00 00       	call   3e3 <wait>

  exit();
 125:	e8 b1 02 00 00       	call   3db <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 76 01 00 00       	call   3f3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 39 01 00 00       	call   41b <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 3c 01 00 00       	call   433 <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 02 01 00 00       	call   403 <close>
  return r;
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 50e:	56                   	push   %esi
 50f:	57                   	push   %edi
 510:	e8 e6 fe ff ff       	call   3fb <write>
  while(--i >= 0)
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 585:	57                   	push   %edi
 586:	56                   	push   %esi
 587:	e8 6f fe ff ff       	call   3fb <write>
 ...
 5de:	e8 18 fe ff ff       	call   3fb <write>
        putc(fd, c);
 ...
 5ef:	57                   	push   %edi
 5f0:	56                   	push   %esi
 5f1:	e8 05 fe ff ff       	call   3fb <write>
        putc(fd, c);
 ...
 65b:	57                   	push   %edi
 65c:	56                   	push   %esi
 65d:	e8 99 fd ff ff       	call   3fb <write>
        while(*s != 0){
 ...
 69c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 69f:	e8 57 fd ff ff       	call   3fb <write>
        ap++;
 ...
 6e1:	a1 20 0c 00 00       	mov    0xc20,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 20 0c 00 00    	mov    %edx,0xc20
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 20 0c 00 00    	mov    %edx,0xc20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 20 0c 00 00    	mov    0xc20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d 20 0c 00 00    	mov    0xc20,%edi
 ...
 7d3:	e8 8b fc ff ff       	call   463 <sbrk>
  if(p == (char*)-1)
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 20 0c 00 00    	mov    0xc20,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 20 0c 00 00    	mov    %edx,0xc20
}
 ...
 837:	0c 00 00 
    base.s.size = 0;
 83a:	bf 24 0c 00 00       	mov    $0xc24,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 24 0c 00 00 24 	movl   $0xc24,0xc24
 846:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 28 0c 00 00 00 	movl   $0x0,0xc28
 852:	00 00 00 
    if(p->s.size >= nunits){
