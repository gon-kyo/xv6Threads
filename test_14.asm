...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 b4 04 00 00       	call   4cb <getpid>
  ...
  1a:	c7 45 f0 2a 00 00 00 	movl   $0x2a,-0x10(%ebp)
   ppid = getpid();
  21:	a3 1c 0d 00 00       	mov    %eax,0xd1c
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 2);
  51:	83 3d 18 0d 00 00 02 	cmpl   $0x2,0xd18
  58:	0f 84 80 00 00 00    	je     de <main+0xde>
  5e:	6a 22                	push   $0x22
  60:	68 d8 08 00 00       	push   $0x8d8
  65:	68 e2 08 00 00       	push   $0x8e2
  6a:	6a 01                	push   $0x1
  6c:	e8 3f 05 00 00       	call   5b0 <printf>
  71:	83 c4 0c             	add    $0xc,%esp
  74:	68 53 09 00 00       	push   $0x953
  79:	eb 1b                	jmp    96 <main+0x96>
   assert(join_pid == thread_pid);
  7b:	6a 21                	push   $0x21
  7d:	68 d8 08 00 00       	push   $0x8d8
  82:	68 e2 08 00 00       	push   $0x8e2
  87:	6a 01                	push   $0x1
  89:	e8 22 05 00 00       	call   5b0 <printf>
  8e:	83 c4 0c             	add    $0xc,%esp
  91:	68 3c 09 00 00       	push   $0x93c
  96:	68 f5 08 00 00       	push   $0x8f5
  9b:	6a 01                	push   $0x1
  9d:	e8 0e 05 00 00       	call   5b0 <printf>
  a2:	5a                   	pop    %edx
  a3:	59                   	pop    %ecx
  a4:	68 09 09 00 00       	push   $0x909
  a9:	6a 01                	push   $0x1
  ab:	e8 00 05 00 00       	call   5b0 <printf>
  b0:	5b                   	pop    %ebx
  b1:	ff 35 1c 0d 00 00    	push   0xd1c
  b7:	e8 bf 03 00 00       	call   47b <kill>
  bc:	e8 8a 03 00 00       	call   44b <exit>
   assert(thread_pid > 0);
  c1:	6a 1e                	push   $0x1e
  c3:	68 d8 08 00 00       	push   $0x8d8
  c8:	68 e2 08 00 00       	push   $0x8e2
  cd:	6a 01                	push   $0x1
  cf:	e8 dc 04 00 00       	call   5b0 <printf>
  ...
  de:	50                   	push   %eax
  df:	50                   	push   %eax
  e0:	68 5f 09 00 00       	push   $0x95f
  e5:	6a 01                	push   $0x1
  e7:	e8 c4 04 00 00       	call   5b0 <printf>
   exit();
  ec:	e8 5a 03 00 00       	call   44b <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 116:	75 78                	jne    190 <worker+0x90>
   assert(global == 1);
 118:	83 3d 18 0d 00 00 01 	cmpl   $0x1,0xd18
 11f:	75 52                	jne    173 <worker+0x73>
   global++;
 121:	c7 05 18 0d 00 00 02 	movl   $0x2,0xd18
 128:	00 00 00 
   // no exit() in thread
}
 12b:	c9                   	leave  
 12c:	c3                   	ret    
   assert(tmp1 == 42);
 12d:	6a 2c                	push   $0x2c
 12f:	68 d8 08 00 00       	push   $0x8d8
 134:	68 e2 08 00 00       	push   $0x8e2
 139:	6a 01                	push   $0x1
 13b:	e8 70 04 00 00       	call   5b0 <printf>
 140:	83 c4 0c             	add    $0xc,%esp
 143:	68 ea 08 00 00       	push   $0x8ea
   assert(tmp2 == 24);
 148:	68 f5 08 00 00       	push   $0x8f5
 14d:	6a 01                	push   $0x1
 ...
 162:	59                   	pop    %ecx
 163:	ff 35 1c 0d 00 00    	push   0xd1c
 169:	e8 0d 03 00 00       	call   47b <kill>
 16e:	e8 d8 02 00 00       	call   44b <exit>
   assert(global == 1);
 173:	6a 2e                	push   $0x2e
 175:	68 d8 08 00 00       	push   $0x8d8
 17a:	68 e2 08 00 00       	push   $0x8e2
 17f:	6a 01                	push   $0x1
 181:	e8 2a 04 00 00       	call   5b0 <printf>
 186:	83 c4 0c             	add    $0xc,%esp
 189:	68 21 09 00 00       	push   $0x921
 18e:	eb b8                	jmp    148 <worker+0x48>
   assert(tmp2 == 24);
 190:	6a 2d                	push   $0x2d
 192:	68 d8 08 00 00       	push   $0x8d8
 197:	68 e2 08 00 00       	push   $0x8e2
 19c:	6a 01                	push   $0x1
 19e:	e8 0d 04 00 00       	call   5b0 <printf>
 1a3:	83 c4 0c             	add    $0xc,%esp
 1a6:	68 16 09 00 00       	push   $0x916
 ...
 50c:	89 d1                	mov    %edx,%ecx
{
 ...
 539:	0f b6 92 cc 09 00 00 	movzbl 0x9cc(%edx),%edx
 ...
 5b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 629:	ff 24 85 74 09 00 00 	jmp    *0x974(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 737:	90                   	nop
          s = "(null)";
 738:	ba 6c 09 00 00       	mov    $0x96c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 751:	a1 20 0d 00 00       	mov    0xd20,%eax
{
 ...
 791:	5b                   	pop    %ebx
  freep = p;
 792:	89 15 20 0d 00 00    	mov    %edx,0xd20
}
 798:	5e                   	pop    %esi
 799:	5f                   	pop    %edi
 79a:	5d                   	pop    %ebp
 ...
 7c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7cc:	89 15 20 0d 00 00    	mov    %edx,0xd20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 3d 20 0d 00 00    	mov    0xd20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 82f:	73 4f                	jae    880 <malloc+0xa0>
    ...
    if(p == freep)
 831:	8b 3d 20 0d 00 00    	mov    0xd20,%edi
 ...
 85a:	e8 f1 fe ff ff       	call   750 <free>
  return freep;
 85f:	8b 15 20 0d 00 00    	mov    0xd20,%edx
 ...
 88c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 88f:	89 15 20 0d 00 00    	mov    %edx,0xd20
}
 ...
 89f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8a0:	c7 05 20 0d 00 00 24 	movl   $0xd24,0xd20
 8a7:	0d 00 00 
    base.s.size = 0;
 8aa:	bf 24 0d 00 00       	mov    $0xd24,%edi
    base.s.ptr = freep = prevp = &base;
 8af:	c7 05 24 0d 00 00 24 	movl   $0xd24,0xd24
 8b6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8bb:	c7 05 28 0d 00 00 00 	movl   $0x0,0xd28
 8c2:	00 00 00 
    if(p->s.size >= nunits){
