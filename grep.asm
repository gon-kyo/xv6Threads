...
main(int argc, char *argv[])
{
  ...
  55:	e8 d9 05 00 00       	call   633 <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 dd 05 00 00       	call   64b <open>
  ...
  81:	e8 ea 06 00 00       	call   770 <printf>
      exit();
  86:	e8 80 05 00 00       	call   60b <exit>
  }
  exit();
  8b:	e8 7b 05 00 00       	call   60b <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 d2 06 00 00       	call   770 <printf>
    exit();
  9e:	e8 68 05 00 00       	call   60b <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 59 05 00 00       	call   60b <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 16 04 00 00       	call   623 <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 9a 03 00 00       	call   62b <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 76 01 00 00       	call   623 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 39 01 00 00       	call   64b <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 3c 01 00 00       	call   663 <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 02 01 00 00       	call   633 <close>
  return r;
 ...
 6cc:	89 d1                	mov    %edx,%ecx
{
 ...
 73e:	56                   	push   %esi
 73f:	57                   	push   %edi
 740:	e8 e6 fe ff ff       	call   62b <write>
  while(--i >= 0)
 ...
 779:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7b5:	57                   	push   %edi
 7b6:	56                   	push   %esi
 7b7:	e8 6f fe ff ff       	call   62b <write>
 ...
 80e:	e8 18 fe ff ff       	call   62b <write>
        putc(fd, c);
 ...
 81f:	57                   	push   %edi
 820:	56                   	push   %esi
 821:	e8 05 fe ff ff       	call   62b <write>
        putc(fd, c);
 ...
 88b:	57                   	push   %edi
 88c:	56                   	push   %esi
 88d:	e8 99 fd ff ff       	call   62b <write>
        while(*s != 0){
 ...
 8cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8cf:	e8 57 fd ff ff       	call   62b <write>
        ap++;
...
free(void *ap)
{
 ...
 911:	a1 60 13 00 00       	mov    0x1360,%eax
{
 ...
 951:	5b                   	pop    %ebx
  freep = p;
 952:	89 15 60 13 00 00    	mov    %edx,0x1360
}
 958:	5e                   	pop    %esi
 959:	5f                   	pop    %edi
 95a:	5d                   	pop    %ebp
 ...
 989:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 98c:	89 15 60 13 00 00    	mov    %edx,0x1360
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9ac:	8b 3d 60 13 00 00    	mov    0x1360,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9ef:	73 4f                	jae    a40 <malloc+0xa0>
    ...
    if(p == freep)
 9f1:	8b 3d 60 13 00 00    	mov    0x1360,%edi
 ...
 a03:	e8 8b fc ff ff       	call   693 <sbrk>
  if(p == (char*)-1)
 ...
 a1a:	e8 f1 fe ff ff       	call   910 <free>
  return freep;
 a1f:	8b 15 60 13 00 00    	mov    0x1360,%edx
 ...
 a4c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a4f:	89 15 60 13 00 00    	mov    %edx,0x1360
}
 ...
 a5f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a60:	c7 05 60 13 00 00 64 	movl   $0x1364,0x1360
 a67:	13 00 00 
    base.s.size = 0;
 a6a:	bf 64 13 00 00       	mov    $0x1364,%edi
    base.s.ptr = freep = prevp = &base;
 a6f:	c7 05 64 13 00 00 64 	movl   $0x1364,0x1364
 a76:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a79:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a7b:	c7 05 68 13 00 00 00 	movl   $0x0,0x1368
 a82:	00 00 00 
    if(p->s.size >= nunits){
