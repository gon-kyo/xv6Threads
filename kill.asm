...
main(int argc, char **argv)
{
  ...
  39:	e8 ed 02 00 00       	call   32b <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 b1 02 00 00       	call   2fb <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 08 04 00 00       	call   460 <printf>
    exit();
  58:	e8 9e 02 00 00       	call   2fb <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
free(void *ap)
{
 ...
 601:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 30 0b 00 00    	mov    %edx,0xb30
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 30 0b 00 00    	mov    %edx,0xb30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 30 0b 00 00    	mov    %edx,0xb30
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 757:	0b 00 00 
    base.s.size = 0;
 75a:	bf 34 0b 00 00       	mov    $0xb34,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 766:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 772:	00 00 00 
    if(p->s.size >= nunits){
