...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 ad 02 00 00       	call   2c3 <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 37 03 00 00       	call   35b <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 9f 02 00 00       	call   2cb <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	57                   	push   %edi
 166:	6a 00                	push   $0x0
 168:	e8 76 01 00 00       	call   2e3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 39 01 00 00       	call   30b <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 3c 01 00 00       	call   323 <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 02 01 00 00       	call   2f3 <close>
  return r;
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 475:	57                   	push   %edi
 476:	56                   	push   %esi
 477:	e8 6f fe ff ff       	call   2eb <write>
 ...
 4ce:	e8 18 fe ff ff       	call   2eb <write>
        putc(fd, c);
 ...
 4df:	57                   	push   %edi
 4e0:	56                   	push   %esi
 4e1:	e8 05 fe ff ff       	call   2eb <write>
        putc(fd, c);
 ...
 58c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 58f:	e8 57 fd ff ff       	call   2eb <write>
        ap++;
...
free(void *ap)
{
 ...
 5d1:	a1 dc 0a 00 00       	mov    0xadc,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 dc 0a 00 00    	mov    %edx,0xadc
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 dc 0a 00 00    	mov    %edx,0xadc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
 ...
 6c3:	e8 8b fc ff ff       	call   353 <sbrk>
  if(p == (char*)-1)
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf e0 0a 00 00       	mov    $0xae0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 742:	00 00 00 
    if(p->s.size >= nunits){
