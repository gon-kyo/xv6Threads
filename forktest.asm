...
main(void)
{
  ...
  exit();
   b:	e8 ab 03 00 00       	call   3bb <exit>
...
00000010 <printf>:
{
  ...
  28:	e8 ae 03 00 00       	call   3db <write>
}
  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  5c:	6a 01                	push   $0x1
  5e:	e8 78 03 00 00       	call   3db <write>
  ...
  7b:	0f 84 83 00 00 00    	je     104 <forktest+0xc4>
    pid = fork();
  81:	e8 2d 03 00 00       	call   3b3 <fork>
    if(pid < 0)
  ...
  8e:	66 90                	xchg   %ax,%ax
    if(wait() < 0){
  90:	e8 2e 03 00 00       	call   3c3 <wait>
  ...
  if(wait() != -1){
  9e:	e8 20 03 00 00       	call   3c3 <wait>
  ...
  be:	6a 01                	push   $0x1
  c0:	e8 16 03 00 00       	call   3db <write>
}
  c5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  c8:	c9                   	leave  
  c9:	c3                   	ret    
      exit();
  ca:	e8 ec 02 00 00       	call   3bb <exit>
  write(fd, s, strlen(s));
  ...
  e5:	6a 01                	push   $0x1
  e7:	e8 ef 02 00 00       	call   3db <write>
      exit();
  ec:	e8 ca 02 00 00       	call   3bb <exit>
  ...
  fa:	e8 11 ff ff ff       	call   10 <printf>
    exit();
  ff:	e8 b7 02 00 00       	call   3bb <exit>
 ...
 111:	e8 fa fe ff ff       	call   10 <printf>
    exit();
 116:	e8 a0 02 00 00       	call   3bb <exit>
 ...
 249:	31 db                	xor    %ebx,%ebx
{
 ...
 255:	57                   	push   %edi
 256:	6a 00                	push   $0x0
 258:	e8 76 01 00 00       	call   3d3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2bd:	e8 39 01 00 00       	call   3fb <open>
  if(fd < 0)
 ...
 2d1:	50                   	push   %eax
 2d2:	e8 3c 01 00 00       	call   413 <fstat>
  close(fd);
 2d7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2da:	89 c6                	mov    %eax,%esi
  close(fd);
 2dc:	e8 02 01 00 00       	call   3e3 <close>
  return r;
