...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 1f 04 00 00       	call   45b <open>
  ...
  59:	e8 e5 03 00 00       	call   443 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 b0 03 00 00       	call   41b <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 06 05 00 00       	call   580 <printf>
      exit();
  7a:	e8 9c 03 00 00       	call   41b <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 89 03 00 00       	call   41b <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 5e 03 00 00       	call   433 <read>
 ...
 16f:	e8 0c 04 00 00       	call   580 <printf>
    exit();
 174:	e8 a2 02 00 00       	call   41b <exit>
...
free(void *ap)
{
 ...
 721:	a1 c0 0e 00 00       	mov    0xec0,%eax
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
 768:	5e                   	pop    %esi
 769:	5f                   	pop    %edi
 76a:	5d                   	pop    %ebp
 ...
 799:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 79c:	89 15 c0 0e 00 00    	mov    %edx,0xec0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 4f                	jae    850 <malloc+0xa0>
    ...
    if(p == freep)
 801:	8b 3d c0 0e 00 00    	mov    0xec0,%edi
 ...
 82a:	e8 f1 fe ff ff       	call   720 <free>
  return freep;
 82f:	8b 15 c0 0e 00 00    	mov    0xec0,%edx
 ...
 85c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 85f:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
 ...
 86f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 c0 0e 00 00 c4 	movl   $0xec4,0xec0
 877:	0e 00 00 
    base.s.size = 0;
 87a:	bf c4 0e 00 00       	mov    $0xec4,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 c4 0e 00 00 c4 	movl   $0xec4,0xec4
 886:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 88b:	c7 05 c8 0e 00 00 00 	movl   $0x0,0xec8
 892:	00 00 00 
    if(p->s.size >= nunits){
