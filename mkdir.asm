...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 49 03 00 00       	call   383 <mkdir>
  ...
  exit();
  4b:	e8 cb 02 00 00       	call   31b <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 0e 04 00 00       	call   480 <printf>
    exit();
  72:	e8 a4 02 00 00       	call   31b <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 76 01 00 00       	call   333 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 39 01 00 00       	call   35b <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 3c 01 00 00       	call   373 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 02 01 00 00       	call   343 <close>
  return r;
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 44e:	56                   	push   %esi
 44f:	57                   	push   %edi
 450:	e8 e6 fe ff ff       	call   33b <write>
  while(--i >= 0)
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c5:	57                   	push   %edi
 4c6:	56                   	push   %esi
 4c7:	e8 6f fe ff ff       	call   33b <write>
 ...
 51e:	e8 18 fe ff ff       	call   33b <write>
        putc(fd, c);
 ...
 52f:	57                   	push   %edi
 530:	56                   	push   %esi
 531:	e8 05 fe ff ff       	call   33b <write>
        putc(fd, c);
 ...
 59b:	57                   	push   %edi
 59c:	56                   	push   %esi
 59d:	e8 99 fd ff ff       	call   33b <write>
        while(*s != 0){
 ...
 5dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5df:	e8 57 fd ff ff       	call   33b <write>
        ap++;
...
free(void *ap)
{
 ...
 621:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 70 0b 00 00    	mov    %edx,0xb70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
 ...
 713:	e8 8b fc ff ff       	call   3a3 <sbrk>
  if(p == (char*)-1)
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 70 0b 00 00    	mov    0xb70,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 70 0b 00 00 74 	movl   $0xb74,0xb70
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 74 0b 00 00       	mov    $0xb74,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 786:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 792:	00 00 00 
    if(p->s.size >= nunits){
