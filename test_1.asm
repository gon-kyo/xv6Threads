...
main(int argc, char *argv[])
{
  ...
  10:	83 ec 1c             	sub    $0x1c,%esp
   ppid = getpid();
  13:	e8 a3 04 00 00       	call   4bb <getpid>
   void *stack, *p = malloc(PGSIZE*2);
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 ec 0c 00 00       	mov    %eax,0xcec
   void *stack, *p = malloc(PGSIZE*2);
  25:	e8 a6 07 00 00       	call   7d0 <malloc>
   assert(p != NULL);
  ...
  4f:	e8 87 04 00 00       	call   4db <clone>
   assert(clone_pid > 0);
  ...
  61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
   while(global != 5);
  68:	8b 15 e8 0c 00 00    	mov    0xce8,%edx
  6e:	83 fa 05             	cmp    $0x5,%edx
  71:	75 f5                	jne    68 <main+0x68>
   printf(1, "TEST PASSED\n");
  73:	50                   	push   %eax
  74:	50                   	push   %eax
  75:	68 1e 09 00 00       	push   $0x91e
  7a:	6a 01                	push   $0x1
  ...
  87:	e8 57 04 00 00       	call   4e3 <join>
   assert(join_pid == clone_pid);
  8c:	83 c4 10             	add    $0x10,%esp
  8f:	39 c6                	cmp    %eax,%esi
  91:	74 52                	je     e5 <main+0xe5>
  93:	6a 29                	push   $0x29
  95:	68 c8 08 00 00       	push   $0x8c8
  9a:	68 d1 08 00 00       	push   $0x8d1
  9f:	6a 01                	push   $0x1
  a1:	e8 fa 04 00 00       	call   5a0 <printf>
  a6:	83 c4 0c             	add    $0xc,%esp
  a9:	68 2b 09 00 00       	push   $0x92b
   assert(clone_pid > 0);
  ae:	68 e5 08 00 00       	push   $0x8e5
  b3:	6a 01                	push   $0x1
  b5:	e8 e6 04 00 00       	call   5a0 <printf>
  ba:	5a                   	pop    %edx
  bb:	59                   	pop    %ecx
  bc:	68 f9 08 00 00       	push   $0x8f9
  c1:	6a 01                	push   $0x1
  c3:	e8 d8 04 00 00       	call   5a0 <printf>
  c8:	5b                   	pop    %ebx
  c9:	ff 35 ec 0c 00 00    	push   0xcec
  cf:	e8 97 03 00 00       	call   46b <kill>
  d4:	e8 62 03 00 00       	call   43b <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  e8:	53                   	push   %ebx
  e9:	e8 52 06 00 00       	call   740 <free>
   exit();
  ee:	e8 48 03 00 00       	call   43b <exit>
   assert(clone_pid > 0);
  f3:	6a 23                	push   $0x23
  f5:	68 c8 08 00 00       	push   $0x8c8
  fa:	68 d1 08 00 00       	push   $0x8d1
  ff:	6a 01                	push   $0x1
 101:	e8 9a 04 00 00       	call   5a0 <printf>
 106:	83 c4 0c             	add    $0xc,%esp
 109:	68 10 09 00 00       	push   $0x910
 10e:	eb 9e                	jmp    ae <main+0xae>
   assert(p != NULL);
 110:	6a 1c                	push   $0x1c
 112:	68 c8 08 00 00       	push   $0x8c8
 117:	68 d1 08 00 00       	push   $0x8d1
 11c:	6a 01                	push   $0x1
 11e:	e8 7d 04 00 00       	call   5a0 <printf>
 123:	83 c4 0c             	add    $0xc,%esp
 126:	68 06 09 00 00       	push   $0x906
...
worker(void *arg1, void *arg2) {
 ...
 133:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 136:	a1 e8 0c 00 00       	mov    0xce8,%eax
 13b:	83 f8 01             	cmp    $0x1,%eax
 13e:	74 46                	je     186 <worker+0x56>
 140:	6a 30                	push   $0x30
 142:	68 c8 08 00 00       	push   $0x8c8
 147:	68 d1 08 00 00       	push   $0x8d1
 14c:	6a 01                	push   $0x1
 14e:	e8 4d 04 00 00       	call   5a0 <printf>
 153:	83 c4 0c             	add    $0xc,%esp
 156:	68 d9 08 00 00       	push   $0x8d9
 15b:	68 e5 08 00 00       	push   $0x8e5
 160:	6a 01                	push   $0x1
 162:	e8 39 04 00 00       	call   5a0 <printf>
 167:	58                   	pop    %eax
 168:	5a                   	pop    %edx
 169:	68 f9 08 00 00       	push   $0x8f9
 16e:	6a 01                	push   $0x1
 170:	e8 2b 04 00 00       	call   5a0 <printf>
 175:	59                   	pop    %ecx
 176:	ff 35 ec 0c 00 00    	push   0xcec
 17c:	e8 ea 02 00 00       	call   46b <kill>
 181:	e8 b5 02 00 00       	call   43b <exit>
   global = 5;
 186:	c7 05 e8 0c 00 00 05 	movl   $0x5,0xce8
 18d:	00 00 00 
   exit();
 190:	e8 a6 02 00 00       	call   43b <exit>
 ...
 2c9:	31 db                	xor    %ebx,%ebx
{
 ...
 2d5:	57                   	push   %edi
 2d6:	6a 00                	push   $0x0
 2d8:	e8 76 01 00 00       	call   453 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 33d:	e8 39 01 00 00       	call   47b <open>
  if(fd < 0)
 ...
 351:	50                   	push   %eax
 352:	e8 3c 01 00 00       	call   493 <fstat>
  close(fd);
 357:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 35a:	89 c6                	mov    %eax,%esi
  close(fd);
 35c:	e8 02 01 00 00       	call   463 <close>
  return r;
 ...
 4fc:	89 d1                	mov    %edx,%ecx
{
 ...
 529:	0f b6 92 a0 09 00 00 	movzbl 0x9a0(%edx),%edx
 ...
 56e:	56                   	push   %esi
 56f:	57                   	push   %edi
 570:	e8 e6 fe ff ff       	call   45b <write>
  while(--i >= 0)
 ...
 5a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e5:	57                   	push   %edi
 5e6:	56                   	push   %esi
 5e7:	e8 6f fe ff ff       	call   45b <write>
 ...
 619:	ff 24 85 48 09 00 00 	jmp    *0x948(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 63e:	e8 18 fe ff ff       	call   45b <write>
        putc(fd, c);
 ...
 64f:	57                   	push   %edi
 650:	56                   	push   %esi
 651:	e8 05 fe ff ff       	call   45b <write>
        putc(fd, c);
 ...
 6bb:	57                   	push   %edi
 6bc:	56                   	push   %esi
 6bd:	e8 99 fd ff ff       	call   45b <write>
        while(*s != 0){
 ...
 6fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6ff:	e8 57 fd ff ff       	call   45b <write>
        ap++;
 ...
 727:	90                   	nop
          s = "(null)";
 728:	ba 41 09 00 00       	mov    $0x941,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 741:	a1 f0 0c 00 00       	mov    0xcf0,%eax
{
 ...
 781:	5b                   	pop    %ebx
  freep = p;
 782:	89 15 f0 0c 00 00    	mov    %edx,0xcf0
}
 788:	5e                   	pop    %esi
 789:	5f                   	pop    %edi
 78a:	5d                   	pop    %ebp
 ...
 7b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7bc:	89 15 f0 0c 00 00    	mov    %edx,0xcf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7dc:	8b 3d f0 0c 00 00    	mov    0xcf0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 81f:	73 4f                	jae    870 <malloc+0xa0>
    ...
    if(p == freep)
 821:	8b 3d f0 0c 00 00    	mov    0xcf0,%edi
 ...
 833:	e8 8b fc ff ff       	call   4c3 <sbrk>
  if(p == (char*)-1)
 ...
 84a:	e8 f1 fe ff ff       	call   740 <free>
  return freep;
 84f:	8b 15 f0 0c 00 00    	mov    0xcf0,%edx
 ...
 87c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 87f:	89 15 f0 0c 00 00    	mov    %edx,0xcf0
}
 ...
 88f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 890:	c7 05 f0 0c 00 00 f4 	movl   $0xcf4,0xcf0
 897:	0c 00 00 
    base.s.size = 0;
 89a:	bf f4 0c 00 00       	mov    $0xcf4,%edi
    base.s.ptr = freep = prevp = &base;
 89f:	c7 05 f4 0c 00 00 f4 	movl   $0xcf4,0xcf4
 8a6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8ab:	c7 05 f8 0c 00 00 00 	movl   $0x0,0xcf8
 8b2:	00 00 00 
    if(p->s.size >= nunits){
