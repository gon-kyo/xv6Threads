...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 30 39 00 00       	call   395b <open>
    ...
    exit();
      40:	e8 d6 38 00 00       	call   391b <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 05 39 00 00       	call   395b <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 e5 38 00 00       	call   3943 <close>
  ...
  exit();
     10d:	e8 09 38 00 00       	call   391b <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 35 38 00 00       	call   398b <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 fd 37 00 00       	call   396b <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 09 38 00 00       	call   398b <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 14 5f 00 00    	push   0x5f14
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 14 5f 00 00    	push   0x5f14
     1ae:	e8 cd 38 00 00       	call   3a80 <printf>
    exit();
     1b3:	e8 63 37 00 00       	call   391b <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 f3 3d 00 00       	push   $0x3df3
     1bf:	ff 35 14 5f 00 00    	push   0x5f14
     1c5:	e8 b6 38 00 00       	call   3a80 <printf>
    exit();
     1ca:	e8 4c 37 00 00       	call   391b <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 d7 3d 00 00       	push   $0x3dd7
     1d6:	ff 35 14 5f 00 00    	push   0x5f14
     1dc:	e8 9f 38 00 00       	call   3a80 <printf>
    exit();
     1e1:	e8 35 37 00 00       	call   391b <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 b6 3d 00 00       	push   $0x3db6
     1ed:	ff 35 14 5f 00 00    	push   0x5f14
     1f3:	e8 88 38 00 00       	call   3a80 <printf>
    exit();
     1f8:	e8 1e 37 00 00       	call   391b <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 14 5f 00 00    	push   0x5f14
     211:	e8 6a 38 00 00       	call   3a80 <printf>
  pid = fork();
     216:	e8 f8 36 00 00       	call   3913 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 4e 37 00 00       	call   3983 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 3e 37 00 00       	call   398b <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 06 37 00 00       	call   396b <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 aa 36 00 00       	call   391b <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 a6 36 00 00       	call   3923 <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 26 3e 00 00       	push   $0x3e26
     285:	ff 35 14 5f 00 00    	push   0x5f14
     ...
     2a0:	ff 35 14 5f 00 00    	push   0x5f14
     2a6:	e8 d5 37 00 00       	call   3a80 <printf>
      exit();
     2ab:	e8 6b 36 00 00       	call   391b <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 e9 4c 00 00       	push   $0x4ce9
     2b7:	ff 35 14 5f 00 00    	push   0x5f14
     2bd:	e8 be 37 00 00       	call   3a80 <printf>
    exit();
     2c2:	e8 54 36 00 00       	call   391b <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 a8 3d 00 00       	push   $0x3da8
     2ce:	ff 35 14 5f 00 00    	push   0x5f14
     2d4:	e8 a7 37 00 00       	call   3a80 <printf>
      exit();
     2d9:	e8 3d 36 00 00       	call   391b <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 12 3e 00 00       	push   $0x3e12
     2e5:	ff 35 14 5f 00 00    	push   0x5f14
     2eb:	e8 90 37 00 00       	call   3a80 <printf>
      exit();
     2f0:	e8 26 36 00 00       	call   391b <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 14 36 00 00       	call   395b <open>
    if(fd >= 0){
     ...
     356:	ff 35 14 5f 00 00    	push   0x5f14
     35c:	e8 1f 37 00 00       	call   3a80 <printf>
      exit();
     361:	e8 b5 35 00 00       	call   391b <exit>
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 66 35 00 00       	call   391b <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 e9 4c 00 00       	push   $0x4ce9
     3bc:	ff 35 14 5f 00 00    	push   0x5f14
     3c2:	e8 b9 36 00 00       	call   3a80 <printf>
    exit();
     3c7:	e8 4f 35 00 00       	call   391b <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 4d 3e 00 00       	push   $0x3e4d
     3d3:	ff 35 14 5f 00 00    	push   0x5f14
     3d9:	e8 a2 36 00 00       	call   3a80 <printf>
    exit();
     3de:	e8 38 35 00 00       	call   391b <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 61 3e 00 00       	push   $0x3e61
     3ea:	ff 35 14 5f 00 00    	push   0x5f14
     3f0:	e8 8b 36 00 00       	call   3a80 <printf>
    exit();
     3f5:	e8 21 35 00 00       	call   391b <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 14 5f 00 00    	push   0x5f14
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 37 35 00 00       	call   395b <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 0f 35 00 00       	call   3943 <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 a5 3e 00 00       	push   $0x3ea5
     43d:	e8 19 35 00 00       	call   395b <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 14 5f 00 00    	push   0x5f14
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 14 5f 00 00    	push   0x5f14
     46e:	e8 0d 36 00 00       	call   3a80 <printf>
    exit();
     473:	e8 a3 34 00 00       	call   391b <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 b2 3e 00 00       	push   $0x3eb2
     47f:	ff 35 14 5f 00 00    	push   0x5f14
     485:	e8 f6 35 00 00       	call   3a80 <printf>
    exit();
     48a:	e8 8c 34 00 00       	call   391b <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 14 5f 00 00    	push   0x5f14
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 a2 34 00 00       	call   395b <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 14 5f 00 00    	push   0x5f14
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 4b 34 00 00       	call   393b <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 2f 34 00 00       	call   393b <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 14 5f 00 00    	push   0x5f14
     52e:	e8 4d 35 00 00       	call   3a80 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 08 34 00 00       	call   3943 <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 ef 3e 00 00       	push   $0x3eef
     544:	e8 12 34 00 00       	call   395b <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 14 5f 00 00    	push   0x5f14
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 b7 33 00 00       	call   3933 <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 14 5f 00 00    	push   0x5f14
     598:	e8 e3 34 00 00       	call   3a80 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 9e 33 00 00       	call   3943 <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 ef 3e 00 00 	movl   $0x3eef,(%esp)
     5ac:	e8 ba 33 00 00       	call   396b <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 14 5f 00 00    	push   0x5f14
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 14 5f 00 00    	push   0x5f14
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 c2 32 00 00       	call   395b <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 72 32 00 00       	call   393b <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 58 32 00 00       	call   3943 <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 37 40 00 00       	push   $0x4037
     6f4:	e8 62 32 00 00       	call   395b <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 f9 31 00 00       	call   3933 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 ed 31 00 00       	call   3943 <close>
  if(unlink("big") < 0){
     756:	c7 04 24 37 40 00 00 	movl   $0x4037,(%esp)
     75d:	e8 09 32 00 00       	call   396b <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 14 5f 00 00    	push   0x5f14
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 14 5f 00 00    	push   0x5f14
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 d0 30 00 00       	call   395b <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 b0 30 00 00       	call   3943 <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 a5 30 00 00       	call   396b <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 14 5f 00 00    	push   0x5f14
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 65 30 00 00       	call   398b <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 4d 30 00 00       	call   398b <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 19 30 00 00       	call   396b <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 14 5f 00 00    	push   0x5f14
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 14 5f 00 00    	push   0x5f14
     97e:	e8 fd 30 00 00       	call   3a80 <printf>
    exit();
     983:	e8 93 2f 00 00       	call   391b <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 a1 40 00 00       	push   $0x40a1
     98f:	ff 35 14 5f 00 00    	push   0x5f14
     995:	e8 e6 30 00 00       	call   3a80 <printf>
    exit();
     99a:	e8 7c 2f 00 00       	call   391b <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 90 40 00 00       	push   $0x4090
     9a6:	ff 35 14 5f 00 00    	push   0x5f14
     9ac:	e8 cf 30 00 00       	call   3a80 <printf>
    exit();
     9b1:	e8 65 2f 00 00       	call   391b <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 7d 40 00 00       	push   $0x407d
     9bd:	ff 35 14 5f 00 00    	push   0x5f14
     9c3:	e8 b8 30 00 00       	call   3a80 <printf>
    exit();
     9c8:	e8 4e 2f 00 00       	call   391b <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 14 5f 00 00    	push   0x5f14
  ...
  if(exec("echo", echoargv) < 0){
     ...
     9f2:	e8 5c 2f 00 00       	call   3953 <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 14 5f 00 00    	push   0x5f14
     a0d:	e8 6e 30 00 00       	call   3a80 <printf>
    exit();
     a12:	e8 04 2f 00 00       	call   391b <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 e1 2e 00 00       	call   3943 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 b6 2e 00 00       	call   3933 <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 67 2e 00 00       	call   3943 <close>
     ...
     b11:	e8 25 2e 00 00       	call   393b <write>
    ...
    exit();
     b28:	e8 ee 2d 00 00       	call   391b <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 02 2e 00 00       	call   3943 <close>
    wait();
     b41:	e8 dd 2d 00 00       	call   3923 <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 14 2f 00 00       	call   3a80 <printf>
      exit();
     b6c:	e8 aa 2d 00 00       	call   391b <exit>
    ...
    exit();
     b7f:	e8 97 2d 00 00       	call   391b <exit>
    ...
    exit();
     b92:	e8 84 2d 00 00       	call   391b <exit>
     ...
     ba0:	e8 db 2e 00 00       	call   3a80 <printf>
        exit();
     ba5:	e8 71 2d 00 00       	call   391b <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 49 2d 00 00       	call   3913 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 34 2d 00 00       	call   3913 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 2f 2d 00 00       	call   392b <pipe>
  pid3 = fork();
     bfc:	e8 12 2d 00 00       	call   3913 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 05 2d 00 00       	call   3943 <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 c8 2c 00 00       	call   3943 <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 ba 2c 00 00       	call   394b <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 b2 2c 00 00       	call   394b <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 aa 2c 00 00       	call   394b <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 6f 2c 00 00       	call   3923 <wait>
  wait();
     cb4:	e8 6a 2c 00 00       	call   3923 <wait>
  wait();
     cb9:	e8 65 2c 00 00       	call   3923 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 fc 2b 00 00       	call   3923 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 de 2b 00 00       	call   3913 <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 8c 2b 00 00       	call   391b <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 f0 2b 00 00       	call   399b <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 61 2b 00 00       	call   3913 <fork>
    ...
    exit();
     e1f:	e8 f7 2a 00 00       	call   391b <exit>
     ...
     e3a:	e8 0c 2b 00 00       	call   394b <kill>
      exit();
     e3f:	e8 d7 2a 00 00       	call   391b <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 d0 2a 00 00       	jmp    3923 <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 ea 2a 00 00       	call   396b <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 e3 41 00 00       	push   $0x41e3
     e8d:	e8 c9 2a 00 00       	call   395b <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 67 2a 00 00       	call   3913 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 5a 2a 00 00       	call   393b <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 18 2a 00 00       	call   3923 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 2a 2a 00 00       	call   3943 <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 e3 41 00 00       	push   $0x41e3
     f22:	e8 34 2a 00 00       	call   395b <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 e2 29 00 00       	call   3933 <read>
  ...
  close(fd);
     ...
     f86:	e8 b8 29 00 00       	call   3943 <close>
  unlink("sharedfd");
     f8b:	c7 04 24 e3 41 00 00 	movl   $0x41e3,(%esp)
     f92:	e8 d4 29 00 00       	call   396b <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 1b 29 00 00       	call   391b <exit>
    ...
    exit();
    100e:	e8 08 29 00 00       	call   391b <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 07 29 00 00       	call   396b <unlink>
    pid = fork();
    1064:	e8 aa 28 00 00       	call   3913 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 96 28 00 00       	call   3923 <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 8f 28 00 00       	call   3923 <wait>
    1094:	e8 8a 28 00 00       	call   3923 <wait>
    1099:	e8 85 28 00 00       	call   3923 <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 a9 28 00 00       	call   395b <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 5e 28 00 00       	call   3933 <read>
    ...
    1104:	e8 3a 28 00 00       	call   3943 <close>
    if(total != 12*500){
    ...
    111e:	e8 48 28 00 00       	call   396b <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 22 29 00 00       	call   3a80 <printf>
          exit();
    115e:	e8 b8 27 00 00       	call   391b <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 ea 27 00 00       	call   395b <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 90 27 00 00       	call   393b <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 5c 27 00 00       	call   391b <exit>
    ...
    11c8:	e8 b3 28 00 00       	call   3a80 <printf>
        exit();
    11cd:	e8 49 27 00 00       	call   391b <exit>
    ...
    11e2:	e8 99 28 00 00       	call   3a80 <printf>
      exit();
    11e7:	e8 2f 27 00 00       	call   391b <exit>
    ...
    11f5:	e8 86 28 00 00       	call   3a80 <printf>
      exit();
    11fa:	e8 1c 27 00 00       	call   391b <exit>
    ...
    1208:	e8 73 28 00 00       	call   3a80 <printf>
          exit();
    120d:	e8 09 27 00 00       	call   391b <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 d4 26 00 00       	call   3913 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 c9 26 00 00       	call   3923 <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 bf 26 00 00       	call   3923 <wait>
    1264:	e8 ba 26 00 00       	call   3923 <wait>
    1269:	e8 b5 26 00 00       	call   3923 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 ad 26 00 00       	call   395b <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 71 26 00 00       	call   3943 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 5b 26 00 00       	call   396b <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 2e 27 00 00       	call   3a80 <printf>
        exit();
    1352:	e8 c4 25 00 00       	call   391b <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 bc 25 00 00       	call   395b <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 94 25 00 00       	call   3943 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 9d 25 00 00       	call   396b <unlink>
    ...
    13de:	e8 9d 26 00 00       	call   3a80 <printf>
            exit();
    13e3:	e8 33 25 00 00       	call   391b <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 26 25 00 00       	call   391b <exit>
    ...
    1400:	e8 7b 26 00 00       	call   3a80 <printf>
        exit();
    1405:	e8 11 25 00 00       	call   391b <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 67 26 00 00       	call   3a80 <printf>
      exit();
    1419:	e8 fd 24 00 00       	call   391b <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 53 26 00 00       	call   3a80 <printf>
          exit();
    142d:	e8 e9 24 00 00       	call   391b <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 f6 24 00 00       	call   395b <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 b9 24 00 00       	call   393b <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 b9 24 00 00       	call   3943 <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 95 42 00 00       	push   $0x4295
    1493:	e8 c3 24 00 00       	call   395b <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 b9 24 00 00       	call   396b <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 8c 24 00 00       	call   395b <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 1a 24 00 00       	call   393b <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 11 24 00 00       	call   3943 <close>
  unlink("unlinkread");
    1532:	c7 04 24 95 42 00 00 	movl   $0x4295,(%esp)
    1539:	e8 2d 24 00 00       	call   396b <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 b2 23 00 00       	call   391b <exit>
    ...
    exit();
    1577:	e8 9f 23 00 00       	call   391b <exit>
    ...
    exit();
    158a:	e8 8c 23 00 00       	call   391b <exit>
    ...
    exit();
    159d:	e8 79 23 00 00       	call   391b <exit>
    ...
    exit();
    15b0:	e8 66 23 00 00       	call   391b <exit>
    ...
    exit();
    15c3:	e8 53 23 00 00       	call   391b <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 12 23 00 00       	call   393b <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 05 23 00 00       	call   3943 <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 5a 43 00 00       	push   $0x435a
    1645:	68 56 43 00 00       	push   $0x4356
    164a:	e8 2c 23 00 00       	call   397b <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 04 23 00 00       	call   396b <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 56 43 00 00       	push   $0x4356
    1670:	e8 e6 22 00 00       	call   395b <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 cc 22 00 00       	call   395b <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 84 22 00 00       	call   3933 <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 7f 22 00 00       	call   3943 <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 5a 43 00 00       	push   $0x435a
    16cb:	68 5a 43 00 00       	push   $0x435a
    16d0:	e8 a6 22 00 00       	call   397b <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 7e 22 00 00       	call   396b <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 56 43 00 00       	push   $0x4356
    16f4:	68 5a 43 00 00       	push   $0x435a
    16f9:	e8 7d 22 00 00       	call   397b <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 64 22 00 00       	call   397b <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 d3 21 00 00       	call   391b <exit>
    ...
    exit();
    1756:	e8 c0 21 00 00       	call   391b <exit>
    ...
    exit();
    1769:	e8 ad 21 00 00       	call   391b <exit>
    ...
    exit();
    177c:	e8 9a 21 00 00       	call   391b <exit>
    ...
    exit();
    178f:	e8 87 21 00 00       	call   391b <exit>
    ...
    exit();
    17a2:	e8 74 21 00 00       	call   391b <exit>
    ...
    exit();
    17b5:	e8 61 21 00 00       	call   391b <exit>
    ...
    exit();
    17c8:	e8 4e 21 00 00       	call   391b <exit>
    ...
    exit();
    17db:	e8 3b 21 00 00       	call   391b <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 2c 21 00 00       	call   395b <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 01 21 00 00       	call   3943 <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 d9 20 00 00       	call   3923 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 09 21 00 00       	call   396b <unlink>
    pid = fork();
    1862:	e8 ac 20 00 00       	call   3913 <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 d1 20 00 00       	call   395b <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 9a 20 00 00       	call   397b <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 3a 20 00 00       	call   3923 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 48 20 00 00       	call   395b <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 07 20 00 00       	call   3933 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 ca 1f 00 00       	call   3943 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 c9 1f 00 00       	call   396b <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 c1 1f 00 00       	call   396b <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 b9 1f 00 00       	call   396b <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 b1 1f 00 00       	call   396b <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 59 1f 00 00       	call   3923 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 32 1f 00 00       	call   3913 <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 4b 1f 00 00       	call   395b <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 2b 1f 00 00       	call   3943 <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 39 1f 00 00       	call   395b <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 19 1f 00 00       	call   3943 <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 27 1f 00 00       	call   395b <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 07 1f 00 00       	call   3943 <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 15 1f 00 00       	call   395b <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 f5 1e 00 00       	call   3943 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 fa 1f 00 00       	call   3a80 <printf>
      exit();
    1a86:	e8 90 1e 00 00       	call   391b <exit>
    ...
    exit();
    1a99:	e8 7d 1e 00 00       	call   391b <exit>
    ...
    1aac:	e8 cf 1f 00 00       	call   3a80 <printf>
        exit();
    1ab1:	e8 65 1e 00 00       	call   391b <exit>
    ...
    1ac4:	e8 b7 1f 00 00       	call   3a80 <printf>
        exit();
    1ac9:	e8 4d 1e 00 00       	call   391b <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 6c 1e 00 00       	call   3943 <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 6a 1e 00 00       	call   396b <unlink>
  pid = fork();
    1b01:	e8 0d 1e 00 00       	call   3913 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 29 1e 00 00       	call   396b <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 e0 1d 00 00       	call   395b <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 c0 1d 00 00       	call   3943 <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 8c 1d 00 00       	call   3923 <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 b9 1d 00 00       	call   397b <link>
    ...
    exit();
    1bd8:	e8 3e 1d 00 00       	call   391b <exit>
    exit();
    1bdd:	e8 39 1d 00 00       	call   391b <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 5a 1d 00 00       	call   396b <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 a5 44 00 00       	push   $0x44a5
    1c1d:	e8 39 1d 00 00       	call   395b <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 08 1d 00 00       	call   3943 <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 0f 1d 00 00       	call   397b <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 de 1c 00 00       	call   396b <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 b4 1c 00 00       	call   396b <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 8e 1d 00 00       	call   3a80 <printf>
      exit();
    1cf2:	e8 24 1c 00 00       	call   391b <exit>
    ...
    1d01:	e8 7a 1d 00 00       	call   3a80 <printf>
      exit();
    1d06:	e8 10 1c 00 00       	call   391b <exit>
    ...
    exit();
    1d19:	e8 fd 1b 00 00       	call   391b <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 2c 1c 00 00       	call   396b <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 18 46 00 00 	movl   $0x4618,(%esp)
    1d46:	e8 38 1c 00 00       	call   3983 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 f3 1b 00 00       	call   395b <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 b6 1b 00 00       	call   393b <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 b6 1b 00 00       	call   3943 <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 18 46 00 00 	movl   $0x4618,(%esp)
    1d94:	e8 d2 1b 00 00       	call   396b <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 d2 1b 00 00       	call   3983 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 8d 1b 00 00       	call   395b <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 50 1b 00 00       	call   393b <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 50 1b 00 00       	call   3943 <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 72 45 00 00       	push   $0x4572
    1dfc:	e8 5a 1b 00 00       	call   395b <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 12 1b 00 00       	call   3933 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 00 1b 00 00       	call   3943 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 b2 45 00 00       	push   $0x45b2
    1e4a:	68 4e 45 00 00       	push   $0x454e
    1e4f:	e8 27 1b 00 00       	call   397b <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 ff 1a 00 00       	call   396b <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 d5 1a 00 00       	call   395b <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 ed 1a 00 00       	call   398b <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 d5 1a 00 00       	call   398b <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 bd 1a 00 00       	call   398b <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 a5 1a 00 00       	call   398b <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 5b 1a 00 00       	call   395b <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 13 1a 00 00       	call   3933 <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 0e 1a 00 00       	call   3943 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 4e 45 00 00       	push   $0x454e
    1f3e:	e8 18 1a 00 00       	call   395b <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 fb 19 00 00       	call   395b <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 de 19 00 00       	call   395b <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 c1 19 00 00       	call   395b <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 a7 19 00 00       	call   395b <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 8d 19 00 00       	call   395b <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 90 19 00 00       	call   397b <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 73 19 00 00       	call   397b <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 56 19 00 00       	call   397b <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 46 19 00 00       	call   3983 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 2e 19 00 00       	call   3983 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 16 19 00 00       	call   3983 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 e6 18 00 00       	call   396b <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 ce 18 00 00       	call   396b <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 d6 18 00 00       	call   398b <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 be 18 00 00       	call   398b <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 86 18 00 00       	call   396b <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 6e 18 00 00       	call   396b <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 56 18 00 00       	call   396b <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 3e 18 00 00       	call   396b <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 26 18 00 00       	call   396b <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 a1 17 00 00       	call   391b <exit>
    ...
    exit();
    2188:	e8 8e 17 00 00       	call   391b <exit>
    ...
    exit();
    219b:	e8 7b 17 00 00       	call   391b <exit>
    ...
    exit();
    21ae:	e8 68 17 00 00       	call   391b <exit>
    ...
    exit();
    21c1:	e8 55 17 00 00       	call   391b <exit>
    ...
    exit();
    21d4:	e8 42 17 00 00       	call   391b <exit>
    ...
    exit();
    21e7:	e8 2f 17 00 00       	call   391b <exit>
    ...
    exit();
    21fa:	e8 1c 17 00 00       	call   391b <exit>
    ...
    exit();
    220d:	e8 09 17 00 00       	call   391b <exit>
    ...
    exit();
    2220:	e8 f6 16 00 00       	call   391b <exit>
    ...
    exit();
    2233:	e8 e3 16 00 00       	call   391b <exit>
    ...
    exit();
    2246:	e8 d0 16 00 00       	call   391b <exit>
    ...
    exit();
    2259:	e8 bd 16 00 00       	call   391b <exit>
    ...
    exit();
    226c:	e8 aa 16 00 00       	call   391b <exit>
    ...
    exit();
    227f:	e8 97 16 00 00       	call   391b <exit>
    ...
    exit();
    2292:	e8 84 16 00 00       	call   391b <exit>
    ...
    exit();
    22a5:	e8 71 16 00 00       	call   391b <exit>
    ...
    exit();
    22b8:	e8 5e 16 00 00       	call   391b <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 4b 16 00 00       	call   391b <exit>
    ...
    exit();
    22de:	e8 38 16 00 00       	call   391b <exit>
    ...
    exit();
    22f1:	e8 25 16 00 00       	call   391b <exit>
    ...
    exit();
    2304:	e8 12 16 00 00       	call   391b <exit>
    ...
    exit();
    2317:	e8 ff 15 00 00       	call   391b <exit>
    ...
    exit();
    232a:	e8 ec 15 00 00       	call   391b <exit>
    ...
    exit();
    233d:	e8 d9 15 00 00       	call   391b <exit>
    ...
    exit();
    2350:	e8 c6 15 00 00       	call   391b <exit>
    ...
    exit();
    2363:	e8 b3 15 00 00       	call   391b <exit>
    ...
    exit();
    2376:	e8 a0 15 00 00       	call   391b <exit>
    ...
    exit();
    2389:	e8 8d 15 00 00       	call   391b <exit>
    ...
    exit();
    239c:	e8 7a 15 00 00       	call   391b <exit>
    ...
    exit();
    23af:	e8 67 15 00 00       	call   391b <exit>
    ...
    exit();
    23c2:	e8 54 15 00 00       	call   391b <exit>
    ...
    exit();
    23d5:	e8 41 15 00 00       	call   391b <exit>
    ...
    exit();
    23e8:	e8 2e 15 00 00       	call   391b <exit>
    ...
    exit();
    23fb:	e8 1b 15 00 00       	call   391b <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 46 15 00 00       	call   396b <unlink>
    ...
    243d:	e8 19 15 00 00       	call   395b <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 e1 14 00 00       	call   393b <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 cb 14 00 00       	call   393b <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 bd 14 00 00       	call   3943 <close>
    unlink("bigwrite");
    2486:	c7 04 24 14 48 00 00 	movl   $0x4814,(%esp)
    248d:	e8 d9 14 00 00       	call   396b <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 bc 15 00 00       	call   3a80 <printf>
        exit();
    24c4:	e8 52 14 00 00       	call   391b <exit>
    ...
    24d3:	e8 a8 15 00 00       	call   3a80 <printf>
      exit();
    24d8:	e8 3e 14 00 00       	call   391b <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 6a 14 00 00       	call   396b <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 70 48 00 00       	push   $0x4870
    250d:	e8 49 14 00 00       	call   395b <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 ed 13 00 00       	call   393b <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 d6 13 00 00       	call   3943 <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 70 48 00 00       	push   $0x4870
    2576:	e8 e0 13 00 00       	call   395b <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 62 13 00 00       	call   3933 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 60 13 00 00       	call   3943 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 6c 13 00 00       	call   396b <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 59 14 00 00       	call   3a80 <printf>
      exit();
    2627:	e8 ef 12 00 00       	call   391b <exit>
    ...
    2636:	e8 45 14 00 00       	call   3a80 <printf>
      exit();
    263b:	e8 db 12 00 00       	call   391b <exit>
    ...
    264a:	e8 31 14 00 00       	call   3a80 <printf>
      exit();
    264f:	e8 c7 12 00 00       	call   391b <exit>
    ...
    265e:	e8 1d 14 00 00       	call   3a80 <printf>
      exit();
    2663:	e8 b3 12 00 00       	call   391b <exit>
    ...
    exit();
    2676:	e8 a0 12 00 00       	call   391b <exit>
    ...
    exit();
    2689:	e8 8d 12 00 00       	call   391b <exit>
    ...
    exit();
    269c:	e8 7a 12 00 00       	call   391b <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 b5 12 00 00       	call   3983 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 9d 12 00 00       	call   3983 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 58 12 00 00       	call   395b <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 2c 12 00 00       	call   3943 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 c8 51 00 00       	push   $0x51c8
    2720:	e8 36 12 00 00       	call   395b <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 0e 12 00 00       	call   3943 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 3c 49 00 00 	movl   $0x493c,(%esp)
    273c:	e8 42 12 00 00       	call   3983 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 2e 12 00 00       	call   3983 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 98 11 00 00       	call   391b <exit>
    ...
    exit();
    2791:	e8 85 11 00 00       	call   391b <exit>
    ...
    exit();
    27a4:	e8 72 11 00 00       	call   391b <exit>
    ...
    exit();
    27b7:	e8 5f 11 00 00       	call   391b <exit>
    ...
    exit();
    27ca:	e8 4c 11 00 00       	call   391b <exit>
    ...
    exit();
    27dd:	e8 39 11 00 00       	call   391b <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 75 11 00 00       	call   3983 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 65 11 00 00       	call   398b <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 2d 11 00 00       	call   396b <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 15 11 00 00       	call   396b <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 1d 11 00 00       	call   398b <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 e5 10 00 00       	call   396b <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 d1 10 00 00       	call   396b <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 bd 10 00 00       	call   396b <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 3f 10 00 00       	call   391b <exit>
    ...
    exit();
    28ea:	e8 2c 10 00 00       	call   391b <exit>
    ...
    exit();
    28fd:	e8 19 10 00 00       	call   391b <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 06 10 00 00       	call   391b <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 f3 0f 00 00       	call   391b <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 e0 0f 00 00       	call   391b <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 cd 0f 00 00       	call   391b <exit>
    ...
    exit();
    295c:	e8 ba 0f 00 00       	call   391b <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 c7 0f 00 00       	call   395b <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 9b 0f 00 00       	call   3943 <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 25 4a 00 00 	movl   $0x4a25,(%esp)
    29af:	e8 d7 0f 00 00       	call   398b <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 8d 0f 00 00       	call   395b <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 70 0f 00 00       	call   395b <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 80 0f 00 00       	call   3983 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 50 0f 00 00       	call   396b <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 43 0f 00 00       	call   397b <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 1b 0f 00 00       	call   396b <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 f1 0e 00 00       	call   395b <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 d7 0e 00 00       	call   395b <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 a5 0e 00 00       	call   393b <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 9d 0e 00 00       	call   3943 <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 4c 0e 00 00       	call   391b <exit>
    ...
    exit();
    2add:	e8 39 0e 00 00       	call   391b <exit>
    ...
    exit();
    2af0:	e8 26 0e 00 00       	call   391b <exit>
    ...
    exit();
    2b03:	e8 13 0e 00 00       	call   391b <exit>
    ...
    exit();
    2b16:	e8 00 0e 00 00       	call   391b <exit>
    ...
    exit();
    2b29:	e8 ed 0d 00 00       	call   391b <exit>
    ...
    exit();
    2b3c:	e8 da 0d 00 00       	call   391b <exit>
    ...
    exit();
    2b4f:	e8 c7 0d 00 00       	call   391b <exit>
    ...
    exit();
    2b62:	e8 b4 0d 00 00       	call   391b <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 e6 0d 00 00       	call   3983 <mkdir>
    ...
    2bb0:	e8 d6 0d 00 00       	call   398b <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 1f 0d 00 00       	call   3943 <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 00 47 00 00       	push   $0x4700
    2c2f:	e8 37 0d 00 00       	call   396b <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 3e 0d 00 00       	call   398b <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 0e 0e 00 00       	call   3a80 <printf>
      exit();
    2c72:	e8 a4 0c 00 00       	call   391b <exit>
    ...
    2c81:	e8 fa 0d 00 00       	call   3a80 <printf>
      exit();
    2c86:	e8 90 0c 00 00       	call   391b <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 51 0c 00 00       	call   3913 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 4e 0c 00 00       	call   3923 <wait>
  ...
  if(wait() != -1){
    2cde:	e8 40 0c 00 00       	call   3923 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 1a 0c 00 00       	call   391b <exit>
    ...
    2d0b:	e8 70 0d 00 00       	call   3a80 <printf>
      exit();
    2d10:	e8 06 0c 00 00       	call   391b <exit>
    ...
    exit();
    2d23:	e8 f3 0b 00 00       	call   391b <exit>
    ...
    exit();
    2d36:	e8 e0 0b 00 00       	call   391b <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 14 5f 00 00    	push   0x5f14
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 17 0c 00 00       	call   39a3 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 66 0b 00 00       	call   3913 <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 df 0b 00 00       	call   39a3 <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 d3 0b 00 00       	call   39a3 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 3b 0b 00 00       	call   3923 <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 b1 0b 00 00       	call   39a3 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 a0 0b 00 00       	call   39a3 <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 8b 0b 00 00       	call   39a3 <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 7d 0b 00 00       	call   39a3 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 67 0b 00 00       	call   39a3 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 4c 0b 00 00       	call   39a3 <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 3e 0b 00 00       	call   39a3 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 27 0b 00 00       	call   39a3 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 be 0a 00 00       	call   399b <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 2f 0a 00 00       	call   3913 <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 2c 0a 00 00       	call   3923 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 1a 0a 00 00       	call   392b <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 e6 09 00 00       	call   3913 <fork>
    ...
    2f48:	e8 e6 09 00 00       	call   3933 <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 3f 0a 00 00       	call   39a3 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 cb 09 00 00       	call   394b <kill>
    wait();
    2f80:	e8 9e 09 00 00       	call   3923 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 01 0a 00 00       	call   39a3 <sbrk>
    2fa2:	83 c4 10             	add    $0x10,%esp
    2fa5:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fa8:	72 68                	jb     3012 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2faa:	83 ec 08             	sub    $0x8,%esp
    2fad:	68 40 4c 00 00       	push   $0x4c40
    2fb2:	ff 35 14 5f 00 00    	push   0x5f14
    2fb8:	e8 c3 0a 00 00       	call   3a80 <printf>
}
    ...
    exit();
    310c:	e8 0a 08 00 00       	call   391b <exit>
    exit();
    3111:	e8 05 08 00 00       	call   391b <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 d5 4b 00 00       	push   $0x4bd5
    311d:	ff 35 14 5f 00 00    	push   0x5f14
    3123:	e8 58 09 00 00       	call   3a80 <printf>
    exit();
    3128:	e8 ee 07 00 00       	call   391b <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 94 53 00 00       	push   $0x5394
    3134:	ff 35 14 5f 00 00    	push   0x5f14
    313a:	e8 41 09 00 00       	call   3a80 <printf>
    exit();
    313f:	e8 d7 07 00 00       	call   391b <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 5c 53 00 00       	push   $0x535c
    314b:	ff 35 14 5f 00 00    	push   0x5f14
    3151:	e8 2a 09 00 00       	call   3a80 <printf>
    exit();
    3156:	e8 c0 07 00 00       	call   391b <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 f1 4b 00 00       	push   $0x4bf1
    3162:	ff 35 14 5f 00 00    	push   0x5f14
    3168:	e8 13 09 00 00       	call   3a80 <printf>
    exit();
    316d:	e8 a9 07 00 00       	call   391b <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31d4:	e8 72 07 00 00       	call   394b <kill>
    wait();
    31d9:	e8 45 07 00 00       	call   3923 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 5d 4c 00 00       	push   $0x4c5d
    31e6:	e8 90 07 00 00       	call   397b <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 14 5f 00 00    	push   0x5f14
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 f8 06 00 00       	call   391b <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 68 4c 00 00       	push   $0x4c68
    322b:	ff 35 14 5f 00 00    	push   0x5f14
    3231:	e8 4a 08 00 00       	call   3a80 <printf>
      exit();
    3236:	e8 e0 06 00 00       	call   391b <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 14 5f 00 00    	push   0x5f14
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 14 5f 00 00    	push   0x5f14
    ...
    3293:	ff 35 14 5f 00 00    	push   0x5f14
    3299:	e8 e2 07 00 00       	call   3a80 <printf>
      exit();
    329e:	e8 78 06 00 00       	call   391b <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 ab 06 00 00       	call   396b <unlink>
  pid = fork();
    32c0:	e8 4e 06 00 00       	call   3913 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 4c 06 00 00       	call   3923 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 b6 4c 00 00       	push   $0x4cb6
    32e1:	e8 75 06 00 00       	call   395b <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 49 06 00 00       	call   3943 <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 b6 4c 00 00 	movl   $0x4cb6,(%esp)
    3301:	e8 65 06 00 00       	call   396b <unlink>
}
    ...
    3310:	c7 04 85 60 a6 00 00 	movl   $0x5410,0xa660(,%eax,4)
    3317:	10 54 00 00 
    ...
    332a:	ff 35 14 5f 00 00    	push   0x5f14
    args[MAXARG-1] = 0;
    ...
    334b:	e8 03 06 00 00       	call   3953 <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 cd 4c 00 00       	push   $0x4ccd
    3357:	ff 35 14 5f 00 00    	push   0x5f14
    ...
    336e:	e8 e8 05 00 00       	call   395b <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 c8 05 00 00       	call   3943 <close>
    exit();
    337b:	e8 9b 05 00 00       	call   391b <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 f6 4c 00 00       	push   $0x4cf6
    3387:	ff 35 14 5f 00 00    	push   0x5f14
    338d:	e8 ee 06 00 00       	call   3a80 <printf>
    exit();
    3392:	e8 84 05 00 00       	call   391b <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 dd 4c 00 00       	push   $0x4cdd
    339e:	ff 35 14 5f 00 00    	push   0x5f14
    33a4:	e8 d7 06 00 00       	call   3a80 <printf>
    exit();
    33a9:	e8 6d 05 00 00       	call   391b <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 fd 04 00 00       	call   395b <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 b6 04 00 00       	call   393b <write>
      if(cc < 512)
    ...
    34a2:	e8 9c 04 00 00       	call   3943 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 1a 04 00 00       	call   396b <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 7c 03 00 00       	call   3913 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 7e 03 00 00       	call   3923 <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 3e 03 00 00       	call   391b <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 2b 03 00 00       	call   391b <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 58 03 00 00       	call   395b <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 8d 03 00 00       	call   39a3 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 0e 03 00 00       	call   3933 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 16 03 00 00       	call   3943 <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3651:	e8 c5 02 00 00       	call   391b <exit>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 76 01 00 00       	call   3933 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 39 01 00 00       	call   395b <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 3c 01 00 00       	call   3973 <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 02 01 00 00       	call   3943 <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
    ...
    38d2:	c3                   	ret    
    38d3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    38da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

000038e0 <lock_acquire>:
...
000038f0 <lock_release>:
    38f0:	55                   	push   %ebp
    38f1:	89 e5                	mov    %esp,%ebp
    38f3:	8b 45 08             	mov    0x8(%ebp),%eax
    38f6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    38fc:	5d                   	pop    %ebp
    38fd:	c3                   	ret    
...
SYSCALL(fork)
    3913:	b8 01 00 00 00       	mov    $0x1,%eax
    3918:	cd 40                	int    $0x40
    391a:	c3                   	ret    

0000391b <exit>:
SYSCALL(exit)
    391b:	b8 02 00 00 00       	mov    $0x2,%eax
    3920:	cd 40                	int    $0x40
    3922:	c3                   	ret    

00003923 <wait>:
SYSCALL(wait)
    3923:	b8 03 00 00 00       	mov    $0x3,%eax
    3928:	cd 40                	int    $0x40
    392a:	c3                   	ret    

0000392b <pipe>:
SYSCALL(pipe)
    392b:	b8 04 00 00 00       	mov    $0x4,%eax
    3930:	cd 40                	int    $0x40
    3932:	c3                   	ret    

00003933 <read>:
SYSCALL(read)
    3933:	b8 05 00 00 00       	mov    $0x5,%eax
    3938:	cd 40                	int    $0x40
    393a:	c3                   	ret    

0000393b <write>:
SYSCALL(write)
    393b:	b8 10 00 00 00       	mov    $0x10,%eax
    3940:	cd 40                	int    $0x40
    3942:	c3                   	ret    

00003943 <close>:
SYSCALL(close)
    3943:	b8 15 00 00 00       	mov    $0x15,%eax
    3948:	cd 40                	int    $0x40
    394a:	c3                   	ret    

0000394b <kill>:
SYSCALL(kill)
    394b:	b8 06 00 00 00       	mov    $0x6,%eax
    3950:	cd 40                	int    $0x40
    3952:	c3                   	ret    

00003953 <exec>:
SYSCALL(exec)
    3953:	b8 07 00 00 00       	mov    $0x7,%eax
    3958:	cd 40                	int    $0x40
    395a:	c3                   	ret    

0000395b <open>:
SYSCALL(open)
    395b:	b8 0f 00 00 00       	mov    $0xf,%eax
    3960:	cd 40                	int    $0x40
    3962:	c3                   	ret    

00003963 <mknod>:
SYSCALL(mknod)
    3963:	b8 11 00 00 00       	mov    $0x11,%eax
    3968:	cd 40                	int    $0x40
    396a:	c3                   	ret    

0000396b <unlink>:
SYSCALL(unlink)
    396b:	b8 12 00 00 00       	mov    $0x12,%eax
    3970:	cd 40                	int    $0x40
    3972:	c3                   	ret    

00003973 <fstat>:
SYSCALL(fstat)
    3973:	b8 08 00 00 00       	mov    $0x8,%eax
    3978:	cd 40                	int    $0x40
    397a:	c3                   	ret    

0000397b <link>:
SYSCALL(link)
    397b:	b8 13 00 00 00       	mov    $0x13,%eax
    3980:	cd 40                	int    $0x40
    3982:	c3                   	ret    

00003983 <mkdir>:
SYSCALL(mkdir)
    3983:	b8 14 00 00 00       	mov    $0x14,%eax
    3988:	cd 40                	int    $0x40
    398a:	c3                   	ret    

0000398b <chdir>:
SYSCALL(chdir)
    398b:	b8 09 00 00 00       	mov    $0x9,%eax
    3990:	cd 40                	int    $0x40
    3992:	c3                   	ret    

00003993 <dup>:
SYSCALL(dup)
    3993:	b8 0a 00 00 00       	mov    $0xa,%eax
    3998:	cd 40                	int    $0x40
    399a:	c3                   	ret    

0000399b <getpid>:
SYSCALL(getpid)
    399b:	b8 0b 00 00 00       	mov    $0xb,%eax
    39a0:	cd 40                	int    $0x40
    39a2:	c3                   	ret    
...
000039bb <clone>:
SYSCALL(clone)
    39bb:	b8 16 00 00 00       	mov    $0x16,%eax
    39c0:	cd 40                	int    $0x40
    39c2:	c3                   	ret    

000039c3 <join>:
SYSCALL(join)
    39c3:	b8 17 00 00 00       	mov    $0x17,%eax
    39c8:	cd 40                	int    $0x40
    39ca:	c3                   	ret    
    ...
    39dc:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a4e:	56                   	push   %esi
    3a4f:	57                   	push   %edi
    3a50:	e8 e6 fe ff ff       	call   393b <write>
  while(--i >= 0)
    ...
    3a89:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3ac5:	57                   	push   %edi
    3ac6:	56                   	push   %esi
    3ac7:	e8 6f fe ff ff       	call   393b <write>
  ...
  write(fd, &c, 1);
    ...
    3b1e:	e8 18 fe ff ff       	call   393b <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b2f:	57                   	push   %edi
    3b30:	56                   	push   %esi
    3b31:	e8 05 fe ff ff       	call   393b <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b9b:	57                   	push   %edi
    3b9c:	56                   	push   %esi
    3b9d:	e8 99 fd ff ff       	call   393b <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3bdf:	e8 57 fd ff ff       	call   393b <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c21:	a1 e0 a6 00 00       	mov    0xa6e0,%eax
{
  ...
  freep = p;
    ...
    3c61:	5b                   	pop    %ebx
  freep = p;
    3c62:	89 15 e0 a6 00 00    	mov    %edx,0xa6e0
}
    3c68:	5e                   	pop    %esi
    3c69:	5f                   	pop    %edi
    3c6a:	5d                   	pop    %ebp
  ...
  freep = p;
    3c9c:	89 15 e0 a6 00 00    	mov    %edx,0xa6e0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cbc:	8b 3d e0 a6 00 00    	mov    0xa6e0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3d01:	8b 3d e0 a6 00 00    	mov    0xa6e0,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d13:	e8 8b fc ff ff       	call   39a3 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3d2f:	8b 15 e0 a6 00 00    	mov    0xa6e0,%edx
    ...
    3d5c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3d5f:	89 15 e0 a6 00 00    	mov    %edx,0xa6e0
}
    ...
    3d6f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3d70:	c7 05 e0 a6 00 00 e4 	movl   $0xa6e4,0xa6e0
    3d77:	a6 00 00 
    base.s.size = 0;
    3d7a:	bf e4 a6 00 00       	mov    $0xa6e4,%edi
    base.s.ptr = freep = prevp = &base;
    3d7f:	c7 05 e4 a6 00 00 e4 	movl   $0xa6e4,0xa6e4
    3d86:	a6 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d89:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3d8b:	c7 05 e8 a6 00 00 00 	movl   $0x0,0xa6e8
    3d92:	00 00 00 
    if(p->s.size >= nunits){
